...
#endif
#ifndef LCACC_BODY_SIG__Deblur1LCacc__X
#define LCACC_BODY_SIG__Deblur1LCacc__X
#define LCACC_CLASS_SIG__Deblur1LCacc__d 1
class InstanceData_sig__Deblur1LCacc
{
public:
	...
	int allocatedAcceleratorCount__deblur1Mega;
	int allocatedAcceleratorIDSet__deblur1Mega[1];
	float (*LCAcc_FuncArgs__conv_in);
	float (*LCAcc_FuncArgs__f);
	float (*LCAcc_FuncArgs__conv_out);
	...
	inline void Reset()
	{
		...
		allocatedAcceleratorCount__deblur1Mega = 0;
		reservedAccelerators = 0;
		allocatedAcceleratorIDSet__deblur1Mega[0] = 0;
		HandlerArgs__d.threadID = threadID;
		HandlerArgs__d.status = 0;
		HandlerArgs__d.taskIndex = 0;
		HandlerArgs__d.lcaccMode = LCACC_CLASS_SIG__Deblur1LCacc__d;
		node_d.Reset();
	}
	inline InstanceData_sig__Deblur1LCacc() :
...
inline void (*GAMHandler_sig__Deblur1LCacc(InstanceData_sig__Deblur1LCacc* instance, InterruptArgs* args))(InstanceData_sig__Deblur1LCacc*) ;
inline void Cleanup_sig__Deblur1LCacc(InstanceData_sig__Deblur1LCacc* instance);
inline void StartEverythingHandler_sig__Deblur1LCacc(InstanceData_sig__Deblur1LCacc* instance);
inline void StopEverythingHandler_sig__Deblur1LCacc(InstanceData_sig__Deblur1LCacc* instance);
inline void ErrorHandler_sig__Deblur1LCacc(InstanceData_sig__Deblur1LCacc* instance);
inline void Wait_sig__Deblur1LCacc(InstanceData_sig__Deblur1LCacc* instance);
inline unsigned int DelayEstimate_sig__Deblur1LCacc(int vectorSize)
{
	return 1;
}
inline void (*ProgressHandler_sig__Deblur1LCacc__d(InstanceData_sig__Deblur1LCacc* instance, InterruptArgs* args))(InstanceData_sig__Deblur1LCacc*);
//This is a procedurally generated interrupt-based program from a RAGraph data structure for function Deblur1LCacc
inline void Wait_sig__Deblur1LCacc(InstanceData_sig__Deblur1LCacc* instance)
{
	while(1)
	{
		...
		InterruptArgs* args = 0;
		void (*progress)(InstanceData_sig__Deblur1LCacc*);
		while((args = LWI_CheckInterrupt(thread)) == 0);
		switch(args->lcaccMode)
		{
			case(0):
				progress = GAMHandler_sig__Deblur1LCacc(instance, args);
				break;
			case(LCACC_CLASS_SIG__Deblur1LCacc__d):
				progress = ProgressHandler_sig__Deblur1LCacc__d(instance, args);
				break;
			default:
				ErrorHandler_sig__Deblur1LCacc(instance);
				simics_assert(0);
		}
	...
	switch(args->status)
	{
		case(LCACC_GAM_WAIT):
			...
			if(instance->reservedAccelerators == 1)
			{
				...
				LCAcc_Reserve(args->threadID, 0, DelayEstimate_sig__Deblur1LCacc(instance->acceleratorVectorLength));
			}
			return 0;
			break;
		case(LCACC_GAM_GRANT):
			...
			{
				case(201):
					if(instance->allocatedAcceleratorCount__deblur1Mega == 1)
					{
						return ErrorHandler_sig__Deblur1LCacc;
					}
					else
					{
						instance->pendingAccelerators++;
						instance->allocatedAcceleratorIDSet__deblur1Mega[instance->allocatedAcceleratorCount__deblur1Mega] = lcaccID;
						instance->allocatedAcceleratorCount__deblur1Mega++;
					}
					break;
				default:
					return ErrorHandler_sig__Deblur1LCacc;
			...
			if(instance->allocatedAcceleratorCount__deblur1Mega == 1)
			{
				return StartEverythingHandler_sig__Deblur1LCacc;
			}
			else
			{
				return 0;
...
inline void Cleanup_sig__Deblur1LCacc(InstanceData_sig__Deblur1LCacc* instance)
{
	...
	if(instance->allocatedAcceleratorIDSet__deblur1Mega[0] != 0)
	{
...
inline void StopEverythingHandler_sig__Deblur1LCacc(InstanceData_sig__Deblur1LCacc* instance)
{
	Cleanup_sig__Deblur1LCacc(instance);
}
inline void ErrorHandler_sig__Deblur1LCacc(InstanceData_sig__Deblur1LCacc* instance)
{
	Cleanup_sig__Deblur1LCacc(instance);
...
inline void (*ProgressHandler_sig__Deblur1LCacc__d(InstanceData_sig__Deblur1LCacc* instance, InterruptArgs* args))(InstanceData_sig__Deblur1LCacc*)
{
	switch(args->status)
	{
		...
		case(LCACC_STATUS_COMPLETED):
			...
			{
				return StopEverythingHandler_sig__Deblur1LCacc;
			}
			else
			{
				return 0;
...
inline void StartEverythingHandler_sig__Deblur1LCacc(InstanceData_sig__Deblur1LCacc* instance)
{
	...
	instance->HandlerArgs__d.lcaccID = instance->allocatedAcceleratorIDSet__deblur1Mega[0];
	...
	instance->HandlerArgs__d.lcaccMode = LCACC_CLASS_SIG__Deblur1LCacc__d;
	...
	Wait_sig__Deblur1LCacc(instance);// wait for everything to finish
}
inline void CreateBuffer_Deblur1LCacc_sig(int thread, InstanceData_sig__Deblur1LCacc* instance, float (*conv_in), float (*f), float (*conv_out), float sigma, int sizeX, int sizeY, int sizeZ, int chunkX, int chunkY, int chunkZ)
{
	...
	instance->node_d.SetSPMConfig((sizeof(float) * (chunkX) * (chunkY) * (chunkZ)) + (sizeof(float) * (chunkX) * (chunkY) * (chunkZ)) + (sizeof(float) * (chunkX) * (chunkY) * (chunkZ)), 3, 0);
	instance->LCAcc_FuncArgs__conv_in = conv_in;
	instance->LCAcc_FuncArgs__f = f;
	instance->LCAcc_FuncArgs__conv_out = conv_out;
	...
	instance->allocatedAcceleratorCount__deblur1Mega = 0;
	LCAccNode& VNR_vardecl_0(instance->node_d);
	void* VNR_vardecl_1(instance->LCAcc_FuncArgs__conv_in);
	void* VNR_vardecl_2(instance->LCAcc_FuncArgs__f);
	void* VNR_vardecl_3(instance->LCAcc_FuncArgs__conv_out);
	std::vector<uint32_t> VNR_vardecl_4;
	VNR_vardecl_4.push_back(((chunkX) - (0)) / (1));
	VNR_vardecl_4.push_back(((chunkY) - (0)) / (1));
	VNR_vardecl_4.push_back(((chunkZ) - (0)) / (1));
	std::vector<int32_t> VNR_vardecl_5;
	VNR_vardecl_5.push_back((1) * (sizeof(float) * (chunkY) * (chunkZ)));
	VNR_vardecl_5.push_back((1) * (sizeof(float) * (chunkZ)));
	VNR_vardecl_5.push_back((1) * (sizeof(float)));
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_6((0) + ((((0) * (sizeof(float) * (chunkY) * (chunkZ))) + ((0) * (sizeof(float) * (chunkZ))) + ((0) * (sizeof(float))))), sizeof(float), VNR_vardecl_4, VNR_vardecl_5);
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_7(((sizeof(float) * (chunkX) * (chunkY) * (chunkZ))) + ((((0) * (sizeof(float) * (chunkY) * (chunkZ))) + ((0) * (sizeof(float) * (chunkZ))) + ((0) * (sizeof(float))))), sizeof(float), VNR_vardecl_4, VNR_vardecl_5);
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_8(((sizeof(float) * (chunkX) * (chunkY) * (chunkZ)) + (sizeof(float) * (chunkX) * (chunkY) * (chunkZ))) + ((((0) * (sizeof(float) * (chunkY) * (chunkZ))) + ((0) * (sizeof(float) * (chunkZ))) + ((0) * (sizeof(float))))), sizeof(float), VNR_vardecl_4, VNR_vardecl_5);
	...
	VNR_vardecl_10.push_back(ConvertToType<float, uint64_t>(sigma)/*Register sigma*/);
	...
	VNR_vardecl_13.push_back((1) * ((sizeof(float) * (sizeY) * (sizeZ))));
	VNR_vardecl_13.push_back((1) * ((sizeof(float) * (sizeZ))));
	...
	instance->acceleratorSignature__d.AddTransfer(VNR_vardecl_1, VNR_vardecl_11, VNR_vardecl_12, VNR_vardecl_4, VNR_vardecl_13, VNR_vardecl_0, (0) + ((((0) * ((sizeof(float)) * (chunkY) * (chunkZ))) + ((0) * ((sizeof(float)) * (chunkZ))) + ((0) * ((sizeof(float)))))), VNR_vardecl_4, VNR_vardecl_14, sizeof(float));
	...
	//Search VNR_vardecl_4 for destination size.
	//Search VNR_vardecl_14 for destination stride.
	instance->acceleratorSignature__d.AddTransfer(VNR_vardecl_2, VNR_vardecl_11, VNR_vardecl_12, VNR_vardecl_4, VNR_vardecl_13, VNR_vardecl_0, ((sizeof(float) * (chunkX) * (chunkY) * (chunkZ))) + ((((0) * ((sizeof(float)) * (chunkY) * (chunkZ))) + ((0) * ((sizeof(float)) * (chunkZ))) + ((0) * ((sizeof(float)))))), VNR_vardecl_4, VNR_vardecl_14, sizeof(float));
	//transfer from d to conv_out
	...
	instance->acceleratorSignature__d.AddTransfer(VNR_vardecl_0, ((sizeof(float) * (chunkX) * (chunkY) * (chunkZ)) + (sizeof(float) * (chunkX) * (chunkY) * (chunkZ))) + ((((0) * ((sizeof(float)) * (chunkY) * (chunkZ))) + ((0) * ((sizeof(float)) * (chunkZ))) + ((0) * ((sizeof(float)))))), VNR_vardecl_4, VNR_vardecl_14, VNR_vardecl_3, VNR_vardecl_11, VNR_vardecl_12, VNR_vardecl_4, VNR_vardecl_13, sizeof(float));
	instance->acceleratorSignature__d.Finalize((((sizeX - 1) - (1)) / (chunkX)) * (((sizeY - 1) - (1)) / (chunkY)) * (((sizeZ - 1) - (1)) / (chunkZ)));
}
inline void Deblur1LCacc_sig_buf(int threadID, InstanceData_sig__Deblur1LCacc* instance)
{
	instance->Reset();
	LWI_RegisterInterruptHandler(&(instance->GAM_INTERACTION));
	LCAcc_Request(threadID, 201, 1);//request something of type AcceleratorType
	Wait_sig__Deblur1LCacc(instance);// wait for everything to finish
}
inline void Deblur1LCacc_sig(int threadID, float (*conv_in), float (*f), float (*conv_out), float sigma, int sizeX, int sizeY, int sizeZ, int chunkX, int chunkY, int chunkZ)
{
	InstanceData_sig__Deblur1LCacc instance;
	CreateBuffer_Deblur1LCacc_sig(threadID, &instance, conv_in, f, conv_out, sigma, sizeX, sizeY, sizeZ, chunkX, chunkY, chunkZ);
	Deblur1LCacc_sig_buf(threadID, &instance);
}
class BiN_Deblur1LCacc_Arbitrator_sig
{
	std::vector<InstanceData_sig__Deblur1LCacc*> instanceSet;
	...
	InterruptArgs isr;
public:
	inline BiN_Deblur1LCacc_Arbitrator_sig(int thread)
	{
		ops.push_back(201);
		count.push_back(1);
		threadID = thread;
	}
	inline void AddConfig(InstanceData_sig__Deblur1LCacc* inst, uint32_t performance, uint32_t cacheMod)
	{
	...
	inline void Run()
	{
		...
		int allocatedAcceleratorCount__deblur1Mega = 0;
		LCAcc_Request(threadID, 201, 1);//request something of type AcceleratorType
		bool cont = true;
				...
				case(LCACC_GAM_GRANT):
					{
						...
						{
							case(201):
								simics_assert(allocatedAcceleratorCount__deblur1Mega < 1);
								allocatedAcceleratorIDSet__deblur1Mega[allocatedAcceleratorCount__deblur1Mega] = lcaccID;
								allocatedAcceleratorCount__deblur1Mega++;
								break;
							default:
								simics_assert(0);
						}
						if(allocatedAcceleratorCount__deblur1Mega == 1)
						{
							cont = false;
						}
					}
		...
		InstanceData_sig__Deblur1LCacc* inst = NULL;
		for(size_t i = 0; i < instanceSet.size(); i++)
		{
		...
		for(int i = 0; i < 1; i++)
		{
			inst->allocatedAcceleratorIDSet__deblur1Mega[i] = allocatedAcceleratorIDSet__deblur1Mega[i];
		}
		inst->allocatedAcceleratorCount__deblur1Mega = allocatedAcceleratorCount__deblur1Mega;
		inst->pendingAccelerators = 1;
		StartEverythingHandler_sig__Deblur1LCacc(inst);
	}
};

#endif
#ifndef LCACC_BODY_TD__Deblur1LCacc__X
#define LCACC_BODY_TD__Deblur1LCacc__X

inline void Wait_td__Deblur1LCacc(int thread)
{
...
inline void CreateBuffer_Deblur1LCacc_td(uint8_t** buffer, uint32_t* bufferSize, uint8_t** constCluster, int thread, float (*conv_in), float (*f), float (*conv_out), float sigma, int sizeX, int sizeY, int sizeZ, int chunkX, int chunkY, int chunkZ)
{
	simics_assert(chunkX > 0);
	simics_assert(chunkY > 0);
	simics_assert(chunkZ > 0);
	...
	void* LCAcc_FuncArgs__conv_in = conv_in;
	void* LCAcc_FuncArgs__f = f;
	void* LCAcc_FuncArgs__conv_out = conv_out;
	{
		void* VNR_vardecl_0(conv_in);
		void* VNR_vardecl_1(f);
		void* VNR_vardecl_2(conv_out);
		LCAccNode VNR_vardecl_3(201, (sizeof(float) * (chunkX) * (chunkY) * (chunkZ)) + (sizeof(float) * (chunkX) * (chunkY) * (chunkZ)) + (sizeof(float) * (chunkX) * (chunkY) * (chunkZ)), 2, 0, 0);
		std::vector<uint32_t> VNR_vardecl_4;
		VNR_vardecl_4.push_back(((chunkX) - (0)) / (1));
		VNR_vardecl_4.push_back(((chunkY) - (0)) / (1));
		VNR_vardecl_4.push_back(((chunkZ) - (0)) / (1));
		...
		//Search VNR_vardecl_4 for destination size.
		//Search VNR_vardecl_14 for destination stride.
		mw.AddTransfer(VNR_vardecl_0, VNR_vardecl_11, VNR_vardecl_12, VNR_vardecl_4, VNR_vardecl_13, VNR_vardecl_3, (0) + ((((0) * ((sizeof(float)) * (chunkY) * (chunkZ))) + ((0) * ((sizeof(float)) * (chunkZ))) + ((0) * ((sizeof(float)))))), VNR_vardecl_4, VNR_vardecl_14, sizeof(float));
		...
		//Search VNR_vardecl_4 for destination size.
		//Search VNR_vardecl_14 for destination stride.
		mw.AddTransfer(VNR_vardecl_1, VNR_vardecl_11, VNR_vardecl_12, VNR_vardecl_4, VNR_vardecl_13, VNR_vardecl_3, ((sizeof(float) * (chunkX) * (chunkY) * (chunkZ))) + ((((0) * ((sizeof(float)) * (chunkY) * (chunkZ))) + ((0) * ((sizeof(float)) * (chunkZ))) + ((0) * ((sizeof(float)))))), VNR_vardecl_4, VNR_vardecl_14, sizeof(float));
		...
		//Search VNR_vardecl_4 for destination element size.
		//Search VNR_vardecl_13 for destination element stride.
		mw.AddTransfer(VNR_vardecl_3, ((sizeof(float) * (chunkX) * (chunkY) * (chunkZ)) + (sizeof(float) * (chunkX) * (chunkY) * (chunkZ))) + ((((0) * ((sizeof(float)) * (chunkY) * (chunkZ))) + ((0) * ((sizeof(float)) * (chunkZ))) + ((0) * ((sizeof(float)))))), VNR_vardecl_4, VNR_vardecl_14, VNR_vardecl_2, VNR_vardecl_11, VNR_vardecl_12, VNR_vardecl_4, VNR_vardecl_13, sizeof(float));
...
inline void Deblur1LCacc_td_buf(uint8_t* buf, uint32_t bufSize, int thread)
{
	...
	Wait_td__Deblur1LCacc(thread);// wait for everything to finish
}
void Deblur1LCacc_td(int thread, float (*conv_in), float (*f), float (*conv_out), float sigma, int sizeX, int sizeY, int sizeZ, int chunkX, int chunkY, int chunkZ)
{
	uint32_t bufSize;
	uint8_t* buffer;
	uint8_t* constCluster = NULL;
	CreateBuffer_Deblur1LCacc_td(&buffer, &bufSize, &constCluster, thread, conv_in, f, conv_out, sigma, sizeX, sizeY, sizeZ, chunkX, chunkY, chunkZ);
	Deblur1LCacc_td_buf(buffer, bufSize, thread);
	if(constCluster)
	{
		delete [] constCluster;
	}
...
inline uint32_t Deblur1LCacc_CalculateBiNSize(float sigma, int sizeX, int sizeY, int sizeZ, int chunkX, int chunkY, int chunkZ)
{
	return 0;
}
class BiN_Deblur1LCacc_Arbitrator_td
{
	...
	InterruptArgs isr;
public:
	inline BiN_Deblur1LCacc_Arbitrator_td(){}
	...
	inline void Run(int threadID)
	{
		...
		isr.lcaccID = 0;
		isr.lcaccMode = 0;
		LCAcc_DeclareLCAccUse(threadID, 201, 1); //requests for deblur1Mega
		...
		for(size_t i = 0; i < binSizeSet.size(); i++)
		{
			...
			{
				Deblur1LCacc_td_buf(bufSet[i], bufSizeSet[i], threadID);
				return;
			}
		}
		simics_assert(0);
