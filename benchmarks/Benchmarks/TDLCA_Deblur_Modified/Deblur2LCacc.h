...
#endif
#ifndef LCACC_BODY_SIG__Deblur2LCacc__X
#define LCACC_BODY_SIG__Deblur2LCacc__X
#define LCACC_CLASS_SIG__Deblur2LCacc__d 1
class InstanceData_sig__Deblur2LCacc
{
public:
	...
	int allocatedAcceleratorCount__deblur2Mega;
	int allocatedAcceleratorIDSet__deblur2Mega[1];
	float (*LCAcc_FuncArgs__u);
	float (*LCAcc_FuncArgs__g);
	float (*LCAcc_FuncArgs__conv);
	...
	inline void Reset()
	{
		...
		allocatedAcceleratorCount__deblur2Mega = 0;
		reservedAccelerators = 0;
		allocatedAcceleratorIDSet__deblur2Mega[0] = 0;
		HandlerArgs__d.threadID = threadID;
		HandlerArgs__d.status = 0;
		HandlerArgs__d.taskIndex = 0;
		HandlerArgs__d.lcaccMode = LCACC_CLASS_SIG__Deblur2LCacc__d;
		node_d.Reset();
	}
	inline InstanceData_sig__Deblur2LCacc() :
...
inline void (*GAMHandler_sig__Deblur2LCacc(InstanceData_sig__Deblur2LCacc* instance, InterruptArgs* args))(InstanceData_sig__Deblur2LCacc*) ;
inline void Cleanup_sig__Deblur2LCacc(InstanceData_sig__Deblur2LCacc* instance);
inline void StartEverythingHandler_sig__Deblur2LCacc(InstanceData_sig__Deblur2LCacc* instance);
inline void StopEverythingHandler_sig__Deblur2LCacc(InstanceData_sig__Deblur2LCacc* instance);
inline void ErrorHandler_sig__Deblur2LCacc(InstanceData_sig__Deblur2LCacc* instance);
inline void Wait_sig__Deblur2LCacc(InstanceData_sig__Deblur2LCacc* instance);
inline unsigned int DelayEstimate_sig__Deblur2LCacc(int vectorSize)
{
	return 1;
}
inline void (*ProgressHandler_sig__Deblur2LCacc__d(InstanceData_sig__Deblur2LCacc* instance, InterruptArgs* args))(InstanceData_sig__Deblur2LCacc*);
//This is a procedurally generated interrupt-based program from a RAGraph data structure for function Deblur2LCacc
inline void Wait_sig__Deblur2LCacc(InstanceData_sig__Deblur2LCacc* instance)
{
	while(1)
	{
		...
		InterruptArgs* args = 0;
		void (*progress)(InstanceData_sig__Deblur2LCacc*);
		while((args = LWI_CheckInterrupt(thread)) == 0);
		switch(args->lcaccMode)
		{
			case(0):
				progress = GAMHandler_sig__Deblur2LCacc(instance, args);
				break;
			case(LCACC_CLASS_SIG__Deblur2LCacc__d):
				progress = ProgressHandler_sig__Deblur2LCacc__d(instance, args);
				break;
			default:
				ErrorHandler_sig__Deblur2LCacc(instance);
				simics_assert(0);
		}
	...
	switch(args->status)
	{
		case(LCACC_GAM_WAIT):
			...
			if(instance->reservedAccelerators == 1)
			{
				...
				LCAcc_Reserve(args->threadID, 0, DelayEstimate_sig__Deblur2LCacc(instance->acceleratorVectorLength));
			}
			return 0;
			break;
		case(LCACC_GAM_GRANT):
			...
			{
				case(202):
					if(instance->allocatedAcceleratorCount__deblur2Mega == 1)
					{
						return ErrorHandler_sig__Deblur2LCacc;
					}
					else
					{
						instance->pendingAccelerators++;
						instance->allocatedAcceleratorIDSet__deblur2Mega[instance->allocatedAcceleratorCount__deblur2Mega] = lcaccID;
						instance->allocatedAcceleratorCount__deblur2Mega++;
					}
					break;
				default:
					return ErrorHandler_sig__Deblur2LCacc;
			...
			if(instance->allocatedAcceleratorCount__deblur2Mega == 1)
			{
				return StartEverythingHandler_sig__Deblur2LCacc;
			}
			else
			{
				return 0;
...
inline void Cleanup_sig__Deblur2LCacc(InstanceData_sig__Deblur2LCacc* instance)
{
	...
	if(instance->allocatedAcceleratorIDSet__deblur2Mega[0] != 0)
	{
...
inline void StopEverythingHandler_sig__Deblur2LCacc(InstanceData_sig__Deblur2LCacc* instance)
{
	Cleanup_sig__Deblur2LCacc(instance);
}
inline void ErrorHandler_sig__Deblur2LCacc(InstanceData_sig__Deblur2LCacc* instance)
{
	Cleanup_sig__Deblur2LCacc(instance);
...
inline void (*ProgressHandler_sig__Deblur2LCacc__d(InstanceData_sig__Deblur2LCacc* instance, InterruptArgs* args))(InstanceData_sig__Deblur2LCacc*)
{
	switch(args->status)
	{
		...
		case(LCACC_STATUS_COMPLETED):
			...
			{
				return StopEverythingHandler_sig__Deblur2LCacc;
			}
			else
			{
				return 0;
...
inline void StartEverythingHandler_sig__Deblur2LCacc(InstanceData_sig__Deblur2LCacc* instance)
{
	...
	instance->HandlerArgs__d.lcaccID = instance->allocatedAcceleratorIDSet__deblur2Mega[0];
	...
	instance->HandlerArgs__d.lcaccMode = LCACC_CLASS_SIG__Deblur2LCacc__d;
	...
	Wait_sig__Deblur2LCacc(instance);// wait for everything to finish
}
inline void CreateBuffer_Deblur2LCacc_sig(int thread, InstanceData_sig__Deblur2LCacc* instance, float (*u), float (*g), float (*conv), float (*result), int sizeX, int sizeY, int sizeZ, int chunkX, int chunkY, int chunkZ, float gamma, float dt)
{
	...
	instance->LCAcc_FuncArgs__conv = conv;
	...
	instance->LCAcc_FuncVars__gamma = gamma;
	instance->LCAcc_FuncVars__dt = dt;
	instance->allocatedAcceleratorCount__deblur2Mega = 0;
	...
	void* VNR_vardecl_3(instance->LCAcc_FuncArgs__conv);
	...
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_10((0) + ((((0) * (sizeof(float) * (chunkY + 2) * (chunkZ + 2))) + ((0) * (sizeof(float) * (chunkZ + 2))) + ((0) * (sizeof(float))))), sizeof(float), VNR_vardecl_9, VNR_vardecl_6);
	...
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_12(((sizeof(float) * (chunkX + 2) * (chunkY + 2) * (chunkZ + 2)) + (sizeof(float) * (chunkX + 2) * (chunkY + 2) * (chunkZ + 2)) + (sizeof(float) * (chunkX) * (chunkY) * (chunkZ))) + ((((0) * (sizeof(float) * (chunkY) * (chunkZ))) + ((0) * (sizeof(float) * (chunkZ))) + ((0) * (sizeof(float))))), sizeof(float), VNR_vardecl_9, VNR_vardecl_11);
	...
	VNR_vardecl_13.push_back(VNR_vardecl_10);
	VNR_vardecl_13.push_back(VNR_vardecl_12);
	std::vector<uint64_t> VNR_vardecl_14;
	VNR_vardecl_14.push_back(ConvertToType<int, uint64_t>(chunkX + 2)/*Register width*/);
	VNR_vardecl_14.push_back(ConvertToType<int, uint64_t>(chunkY + 2)/*Register height*/);
	VNR_vardecl_14.push_back(ConvertToType<int, uint64_t>(chunkZ + 2)/*Register depth*/);
	VNR_vardecl_14.push_back(ConvertToType<float, uint64_t>(dt)/*Register dt*/);
	VNR_vardecl_14.push_back(ConvertToType<float, uint64_t>(gamma)/*Register gamma*/);
...
inline void Deblur2LCacc_sig_buf(int threadID, InstanceData_sig__Deblur2LCacc* instance)
{
	instance->Reset();
	LWI_RegisterInterruptHandler(&(instance->GAM_INTERACTION));
	LCAcc_Request(threadID, 202, 1);//request something of type AcceleratorType
	Wait_sig__Deblur2LCacc(instance);// wait for everything to finish
}
inline void Deblur2LCacc_sig(int threadID, float (*u), float (*g), float (*conv), float (*result), int sizeX, int sizeY, int sizeZ, int chunkX, int chunkY, int chunkZ, float gamma, float dt)
{
	InstanceData_sig__Deblur2LCacc instance;
	CreateBuffer_Deblur2LCacc_sig(threadID, &instance, u, g, conv, result, sizeX, sizeY, sizeZ, chunkX, chunkY, chunkZ, gamma, dt);
	Deblur2LCacc_sig_buf(threadID, &instance);
}
class BiN_Deblur2LCacc_Arbitrator_sig
{
	std::vector<InstanceData_sig__Deblur2LCacc*> instanceSet;
	...
	InterruptArgs isr;
public:
	inline BiN_Deblur2LCacc_Arbitrator_sig(int thread)
	{
		ops.push_back(202);
		count.push_back(1);
		threadID = thread;
	}
	inline void AddConfig(InstanceData_sig__Deblur2LCacc* inst, uint32_t performance, uint32_t cacheMod)
	{
	...
	inline void Run()
	{
		...
		int allocatedAcceleratorCount__deblur2Mega = 0;
		LCAcc_Request(threadID, 202, 1);//request something of type AcceleratorType
		bool cont = true;
				...
				case(LCACC_GAM_GRANT):
					{
						...
						{
							case(202):
								simics_assert(allocatedAcceleratorCount__deblur2Mega < 1);
								allocatedAcceleratorIDSet__deblur2Mega[allocatedAcceleratorCount__deblur2Mega] = lcaccID;
								allocatedAcceleratorCount__deblur2Mega++;
								break;
							default:
								simics_assert(0);
						}
						if(allocatedAcceleratorCount__deblur2Mega == 1)
						{
							cont = false;
						}
					}
		...
		InstanceData_sig__Deblur2LCacc* inst = NULL;
		for(size_t i = 0; i < instanceSet.size(); i++)
		{
		...
		for(int i = 0; i < 1; i++)
		{
			inst->allocatedAcceleratorIDSet__deblur2Mega[i] = allocatedAcceleratorIDSet__deblur2Mega[i];
		}
		inst->allocatedAcceleratorCount__deblur2Mega = allocatedAcceleratorCount__deblur2Mega;
		inst->pendingAccelerators = 1;
		StartEverythingHandler_sig__Deblur2LCacc(inst);
	}
};

#endif
#ifndef LCACC_BODY_TD__Deblur2LCacc__X
#define LCACC_BODY_TD__Deblur2LCacc__X

inline void Wait_td__Deblur2LCacc(int thread)
{
...
inline void CreateBuffer_Deblur2LCacc_td(uint8_t** buffer, uint32_t* bufferSize, uint8_t** constCluster, int thread, float (*u), float (*g), float (*conv), float (*result), int sizeX, int sizeY, int sizeZ, int chunkX, int chunkY, int chunkZ, float gamma, float dt)
{
	simics_assert(chunkX > 0);
	simics_assert(chunkY > 0);
	simics_assert(chunkZ > 0);
	...
	void* LCAcc_FuncArgs__conv = conv;
	void* LCAcc_FuncArgs__result = result;
	{
		void* VNR_vardecl_0(u);
		void* VNR_vardecl_1(g);
		void* VNR_vardecl_2(conv);
		void* VNR_vardecl_3(result);
		LCAccNode VNR_vardecl_4(202, (sizeof(float) * (chunkX + 2) * (chunkY + 2) * (chunkZ + 2)) + (sizeof(float) * (chunkX + 2) * (chunkY + 2) * (chunkZ + 2)) + (sizeof(float) * (chunkX) * (chunkY) * (chunkZ)) + (sizeof(float) * (chunkX) * (chunkY) * (chunkZ)), 2, 0, 0);
		std::vector<uint32_t> VNR_vardecl_5;
		VNR_vardecl_5.push_back(((chunkX + 1) - (1)) / (1));
		VNR_vardecl_5.push_back(((chunkY + 1) - (1)) / (1));
		VNR_vardecl_5.push_back(((chunkZ + 1) - (1)) / (1));
		...
		//Search VNR_vardecl_17 for destination size.
		//Search VNR_vardecl_19 for destination stride.
		mw.AddTransfer(VNR_vardecl_1, VNR_vardecl_15, VNR_vardecl_16, VNR_vardecl_17, VNR_vardecl_18, VNR_vardecl_4, ((sizeof(float) * (chunkX + 2) * (chunkY + 2) * (chunkZ + 2))) + ((((0) * ((sizeof(float)) * (chunkY + 2) * (chunkZ + 2))) + ((0) * ((sizeof(float)) * (chunkZ + 2))) + ((0) * ((sizeof(float)))))), VNR_vardecl_17, VNR_vardecl_19, sizeof(float));
		...
		//Search VNR_vardecl_9 for destination size.
		//Search VNR_vardecl_20 for destination stride.
		mw.AddTransfer(VNR_vardecl_2, VNR_vardecl_15, VNR_vardecl_16, VNR_vardecl_9, VNR_vardecl_18, VNR_vardecl_4, ((sizeof(float) * (chunkX + 2) * (chunkY + 2) * (chunkZ + 2)) + (sizeof(float) * (chunkX + 2) * (chunkY + 2) * (chunkZ + 2))) + ((((0) * ((sizeof(float)) * (chunkY) * (chunkZ))) + ((0) * ((sizeof(float)) * (chunkZ))) + ((0) * ((sizeof(float)))))), VNR_vardecl_9, VNR_vardecl_20, sizeof(float));
...
inline void Deblur2LCacc_td_buf(uint8_t* buf, uint32_t bufSize, int thread)
{
	...
	Wait_td__Deblur2LCacc(thread);// wait for everything to finish
}
void Deblur2LCacc_td(int thread, float (*u), float (*g), float (*conv), float (*result), int sizeX, int sizeY, int sizeZ, int chunkX, int chunkY, int chunkZ, float gamma, float dt)
{
	uint32_t bufSize;
	uint8_t* buffer;
	uint8_t* constCluster = NULL;
	CreateBuffer_Deblur2LCacc_td(&buffer, &bufSize, &constCluster, thread, u, g, conv, result, sizeX, sizeY, sizeZ, chunkX, chunkY, chunkZ, gamma, dt);
	Deblur2LCacc_td_buf(buffer, bufSize, thread);
	if(constCluster)
	{
		delete [] constCluster;
	}
...
inline uint32_t Deblur2LCacc_CalculateBiNSize(int sizeX, int sizeY, int sizeZ, int chunkX, int chunkY, int chunkZ, float gamma, float dt)
{
	return 0;
}
class BiN_Deblur2LCacc_Arbitrator_td
{
	...
	InterruptArgs isr;
public:
	inline BiN_Deblur2LCacc_Arbitrator_td(){}
	...
	inline void Run(int threadID)
	{
		...
		isr.lcaccID = 0;
		isr.lcaccMode = 0;
		LCAcc_DeclareLCAccUse(threadID, 202, 1); //requests for deblur2Mega
		...
		for(size_t i = 0; i < binSizeSet.size(); i++)
		{
			...
			{
				Deblur2LCacc_td_buf(bufSet[i], bufSizeSet[i], threadID);
				return;
			}
		}
		simics_assert(0);
