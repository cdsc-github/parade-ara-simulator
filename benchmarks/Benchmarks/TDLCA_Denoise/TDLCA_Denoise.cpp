...
void TDLCA_Denoise::Initialize(int threadID, int procID)
{
    ...
    CreateBuffer_Denoise1LCacc_td(&buf1, &buf1Size, &constCluster1, 
        thread, u, g, dataSize, dataSize,  dataSize, 16, 16, 16);
    CreateBuffer_Denoise2LCacc_td(&buf2, &buf2Size, &constCluster2, 
        thread, u, f, g, ret_u, dataSize, dataSize, dataSize, 16, 16, 16, 
        1.0f, 2.0f, 3.0f);
