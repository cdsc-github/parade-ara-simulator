...
#endif
#ifndef LCACC_BODY_SIG__DispMapIntegSum2LCacc__X
#define LCACC_BODY_SIG__DispMapIntegSum2LCacc__X
#define LCACC_CLASS_SIG__DispMapIntegSum2LCacc__sa 1
class InstanceData_sig__DispMapIntegSum2LCacc
{
public:
	...
	inline void Reset()
	{
		...
		HandlerArgs__sa.lcaccMode = LCACC_CLASS_SIG__DispMapIntegSum2LCacc__sa;
		node_sa.Reset();
	}
...
inline void Cleanup_sig__DispMapIntegSum2LCacc(InstanceData_sig__DispMapIntegSum2LCacc* instance);
inline void StartEverythingHandler_sig__DispMapIntegSum2LCacc(InstanceData_sig__DispMapIntegSum2LCacc* instance);
inline void StopEverythingHandler_sig__DispMapIntegSum2LCacc(InstanceData_sig__DispMapIntegSum2LCacc* instance);
inline void ErrorHandler_sig__DispMapIntegSum2LCacc(InstanceData_sig__DispMapIntegSum2LCacc* instance);
inline void Wait_sig__DispMapIntegSum2LCacc(InstanceData_sig__DispMapIntegSum2LCacc* instance);
inline unsigned int DelayEstimate_sig__DispMapIntegSum2LCacc(int vectorSize)
{
	return 1;
}
inline void (*ProgressHandler_sig__DispMapIntegSum2LCacc__sa(InstanceData_sig__DispMapIntegSum2LCacc* instance, InterruptArgs* args))(InstanceData_sig__DispMapIntegSum2LCacc*);
//This is a procedurally generated interrupt-based program from a RAGraph data structure for function DispMapIntegSum2LCacc
inline void Wait_sig__DispMapIntegSum2LCacc(InstanceData_sig__DispMapIntegSum2LCacc* instance)
{
	while(1)
	{
		...
		InterruptArgs* args = 0;
		void (*progress)(InstanceData_sig__DispMapIntegSum2LCacc*);
		while((args = LWI_CheckInterrupt(thread)) == 0);
		switch(args->lcaccMode)
		{
			case(0):
				progress = GAMHandler_sig__DispMapIntegSum2LCacc(instance, args);
				break;
			case(LCACC_CLASS_SIG__DispMapIntegSum2LCacc__sa):
				progress = ProgressHandler_sig__DispMapIntegSum2LCacc__sa(instance, args);
				break;
			default:
				ErrorHandler_sig__DispMapIntegSum2LCacc(instance);
				simics_assert(0);
		}
	...
	switch(args->status)
	{
		case(LCACC_GAM_WAIT):
			...
			if(instance->reservedAccelerators == 1)
			{
				...
				LCAcc_Reserve(args->threadID, 0, DelayEstimate_sig__DispMapIntegSum2LCacc(instance->acceleratorVectorLength));
			}
			return 0;
			break;
		case(LCACC_GAM_GRANT):
			...
			switch(lcaccMode)
			{
				case(831):
					...
					{
						return ErrorHandler_sig__DispMapIntegSum2LCacc;
					}
					else
					{
			...
			if(instance->allocatedAcceleratorCount__DispMapIntegSum == 1)
			{
				return StartEverythingHandler_sig__DispMapIntegSum2LCacc;
			}
			else
			{
				return 0;
...
inline void StopEverythingHandler_sig__DispMapIntegSum2LCacc(InstanceData_sig__DispMapIntegSum2LCacc* instance)
{
	Cleanup_sig__DispMapIntegSum2LCacc(instance);
}
inline void ErrorHandler_sig__DispMapIntegSum2LCacc(InstanceData_sig__DispMapIntegSum2LCacc* instance)
{
	Cleanup_sig__DispMapIntegSum2LCacc(instance);
...
inline void (*ProgressHandler_sig__DispMapIntegSum2LCacc__sa(InstanceData_sig__DispMapIntegSum2LCacc* instance, InterruptArgs* args))(InstanceData_sig__DispMapIntegSum2LCacc*)
{
	switch(args->status)
	{
		...
		case(LCACC_STATUS_COMPLETED):
			...
			{
				return StopEverythingHandler_sig__DispMapIntegSum2LCacc;
			}
			else
			{
				return 0;
...
inline void StartEverythingHandler_sig__DispMapIntegSum2LCacc(InstanceData_sig__DispMapIntegSum2LCacc* instance)
{
	...
	instance->HandlerArgs__sa.lcaccMode = LCACC_CLASS_SIG__DispMapIntegSum2LCacc__sa;
	...
	Wait_sig__DispMapIntegSum2LCacc(instance);// wait for everything to finish
}
inline void CreateBuffer_DispMapIntegSum2LCacc_sig(int thread, InstanceData_sig__DispMapIntegSum2LCacc* instance, float (*in_val_array), float (*out_sum_array), int dataSize, int SHIFT, int n1, int n2, int chunk1, int chunk2, int chunk3, int chunk4)
{
	...
	VNR_vardecl_10.push_back((chunk3) * ((sizeof(float))));
	VNR_vardecl_10.push_back((chunk4) * ((sizeof(float) * n1)));
	...
	VNR_vardecl_11.push_back((1) * ((sizeof(float) * n1)));
...
inline void DispMapIntegSum2LCacc_sig_buf(int threadID, InstanceData_sig__DispMapIntegSum2LCacc* instance)
{
	instance->Reset();
...
inline void DispMapIntegSum2LCacc_sig(int threadID, float (*in_val_array), float (*out_sum_array), int dataSize, int SHIFT, int n1, int n2, int chunk1, int chunk2, int chunk3, int chunk4)
{
	InstanceData_sig__DispMapIntegSum2LCacc instance;
	CreateBuffer_DispMapIntegSum2LCacc_sig(threadID, &instance, in_val_array, out_sum_array, dataSize, SHIFT, n1, n2, chunk1, chunk2, chunk3, chunk4);
	DispMapIntegSum2LCacc_sig_buf(threadID, &instance);
}
class BiN_DispMapIntegSum2LCacc_Arbitrator_sig
{
	std::vector<InstanceData_sig__DispMapIntegSum2LCacc*> instanceSet;
	...
	InterruptArgs isr;
public:
	inline BiN_DispMapIntegSum2LCacc_Arbitrator_sig(int thread)
	{
		ops.push_back(831);
		count.push_back(1);
		threadID = thread;
	}
	inline void AddConfig(InstanceData_sig__DispMapIntegSum2LCacc* inst, uint32_t performance, uint32_t cacheMod)
	{
	...
	inline void Run()
	{
		...
		InstanceData_sig__DispMapIntegSum2LCacc* inst = NULL;
		for(size_t i = 0; i < instanceSet.size(); i++)
		{
		...
		StartEverythingHandler_sig__DispMapIntegSum2LCacc(inst);
	}
};

#endif
#ifndef LCACC_BODY_TD__DispMapIntegSum2LCacc__X
#define LCACC_BODY_TD__DispMapIntegSum2LCacc__X

inline void Wait_td__DispMapIntegSum2LCacc(int thread)
{
...
inline void CreateBuffer_DispMapIntegSum2LCacc_td(uint8_t** buffer, uint32_t* bufferSize, uint8_t** constCluster, int thread, float (*in_val_array), float (*out_sum_array), int dataSize, int SHIFT, int n1, int n2, int chunk1, int chunk2, int chunk3, int chunk4)
{
	simics_assert(dataSize > 0);
	simics_assert(SHIFT > 0);
	simics_assert(n1 > 0);
...
inline void DispMapIntegSum2LCacc_td_buf(uint8_t* buf, uint32_t bufSize, int thread)
{
	...
	Wait_td__DispMapIntegSum2LCacc(thread);// wait for everything to finish
}
void DispMapIntegSum2LCacc_td(int thread, float (*in_val_array), float (*out_sum_array), int dataSize, int SHIFT, int n1, int n2, int chunk1, int chunk2, int chunk3, int chunk4)
{
	uint32_t bufSize;
	uint8_t* buffer;
	uint8_t* constCluster = NULL;
	CreateBuffer_DispMapIntegSum2LCacc_td(&buffer, &bufSize, &constCluster, thread, in_val_array, out_sum_array, dataSize, SHIFT, n1, n2, chunk1, chunk2, chunk3, chunk4);
	DispMapIntegSum2LCacc_td_buf(buffer, bufSize, thread);
	if(constCluster)
	{
		delete [] constCluster;
	}
...
inline uint32_t DispMapIntegSum2LCacc_CalculateBiNSize(int dataSize, int SHIFT, int n1, int n2, int chunk1, int chunk2, int chunk3, int chunk4)
{
	return 0;
}
class BiN_DispMapIntegSum2LCacc_Arbitrator_td
{
	...
	InterruptArgs isr;
public:
	inline BiN_DispMapIntegSum2LCacc_Arbitrator_td(){}
	...
	inline void Run(int threadID)
	{
		...
		for(size_t i = 0; i < binSizeSet.size(); i++)
		{
			...
			{
				DispMapIntegSum2LCacc_td_buf(bufSet[i], bufSizeSet[i], threadID);
				return;
			}
		}
		simics_assert(0);
