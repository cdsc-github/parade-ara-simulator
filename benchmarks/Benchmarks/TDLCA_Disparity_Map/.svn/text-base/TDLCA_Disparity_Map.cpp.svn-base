...
void TDLCA_Disparity_Map::Initialize(int threadID, int procID)
{
	...
	CreateBuffer_DispMapCompSADLCacc_td(&buf1, &bufSize1, &constCluster1, thread, (float*)ILeft, (float*)IRight, (float*)SAD, dataSize, SHIFT, IMG_H + WIN, IMG_W + WIN, 1, 1, 1, IMG_W + WIN);
	CreateBuffer_DispMapIntegSum1LCacc_td(&buf2, &bufSize2, &constCluster2, thread, (float*)SAD, (float*)SAD, dataSize, SHIFT, IMG_H + WIN, IMG_W + WIN, 1, 1, 1, IMG_W + WIN);
	CreateBuffer_DispMapIntegSum2LCacc_td(&buf3, &bufSize3, &constCluster3, thread, (float*)SAD, (float*)SAD, dataSize, SHIFT, IMG_H + WIN, IMG_W + WIN, 1, 1, 1, IMG_W + WIN);
	CreateBuffer_DispMapFindDispLCacc_td(&buf4, &bufSize4, &constCluster4, thread, (float*)SAD, (float*)retDisp, dataSize, IMG_H, IMG_W, SHIFT, WIN, 1, 1, 512 / IMG_W, IMG_W);
