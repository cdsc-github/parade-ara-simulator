...
#endif
#ifndef LCACC_BODY_SIG__DispMapFindDispLCacc__X
#define LCACC_BODY_SIG__DispMapFindDispLCacc__X
#define LCACC_CLASS_SIG__DispMapFindDispLCacc__sa 1
class InstanceData_sig__DispMapFindDispLCacc
{
public:
	...
	int allocatedAcceleratorCount__DispMapFindDisp;
	int allocatedAcceleratorIDSet__DispMapFindDisp[1];
	float (*LCAcc_FuncArgs__in_imgIntegral);
	float (*LCAcc_FuncArgs__out_Disp);
	int LCAcc_FuncVars__dataSize;
	int LCAcc_FuncVars__nRows;
	int LCAcc_FuncVars__nCols;
	int LCAcc_FuncVars__SHIFT;
	int LCAcc_FuncVars__WIN;
	...
	inline void Reset()
	{
		...
		allocatedAcceleratorCount__DispMapFindDisp = 0;
		reservedAccelerators = 0;
		allocatedAcceleratorIDSet__DispMapFindDisp[0] = 0;
		HandlerArgs__sa.threadID = threadID;
		HandlerArgs__sa.status = 0;
		HandlerArgs__sa.taskIndex = 0;
		HandlerArgs__sa.lcaccMode = LCACC_CLASS_SIG__DispMapFindDispLCacc__sa;
		node_sa.Reset();
	}
	inline InstanceData_sig__DispMapFindDispLCacc() :
...
inline void (*GAMHandler_sig__DispMapFindDispLCacc(InstanceData_sig__DispMapFindDispLCacc* instance, InterruptArgs* args))(InstanceData_sig__DispMapFindDispLCacc*) ;
inline void Cleanup_sig__DispMapFindDispLCacc(InstanceData_sig__DispMapFindDispLCacc* instance);
inline void StartEverythingHandler_sig__DispMapFindDispLCacc(InstanceData_sig__DispMapFindDispLCacc* instance);
inline void StopEverythingHandler_sig__DispMapFindDispLCacc(InstanceData_sig__DispMapFindDispLCacc* instance);
inline void ErrorHandler_sig__DispMapFindDispLCacc(InstanceData_sig__DispMapFindDispLCacc* instance);
inline void Wait_sig__DispMapFindDispLCacc(InstanceData_sig__DispMapFindDispLCacc* instance);
inline unsigned int DelayEstimate_sig__DispMapFindDispLCacc(int vectorSize)
{
	return 1;
}
inline void (*ProgressHandler_sig__DispMapFindDispLCacc__sa(InstanceData_sig__DispMapFindDispLCacc* instance, InterruptArgs* args))(InstanceData_sig__DispMapFindDispLCacc*);
//This is a procedurally generated interrupt-based program from a RAGraph data structure for function DispMapFindDispLCacc
inline void Wait_sig__DispMapFindDispLCacc(InstanceData_sig__DispMapFindDispLCacc* instance)
{
	while(1)
	{
		...
		InterruptArgs* args = 0;
		void (*progress)(InstanceData_sig__DispMapFindDispLCacc*);
		while((args = LWI_CheckInterrupt(thread)) == 0);
		switch(args->lcaccMode)
		{
			case(0):
				progress = GAMHandler_sig__DispMapFindDispLCacc(instance, args);
				break;
			case(LCACC_CLASS_SIG__DispMapFindDispLCacc__sa):
				progress = ProgressHandler_sig__DispMapFindDispLCacc__sa(instance, args);
				break;
			default:
				ErrorHandler_sig__DispMapFindDispLCacc(instance);
				simics_assert(0);
		}
	...
	switch(args->status)
	{
		case(LCACC_GAM_WAIT):
			...
			if(instance->reservedAccelerators == 1)
			{
				...
				LCAcc_Reserve(args->threadID, 0, DelayEstimate_sig__DispMapFindDispLCacc(instance->acceleratorVectorLength));
			}
			return 0;
			break;
		case(LCACC_GAM_GRANT):
			...
			{
				case(832):
					if(instance->allocatedAcceleratorCount__DispMapFindDisp == 1)
					{
						return ErrorHandler_sig__DispMapFindDispLCacc;
					}
					else
					{
						instance->pendingAccelerators++;
						instance->allocatedAcceleratorIDSet__DispMapFindDisp[instance->allocatedAcceleratorCount__DispMapFindDisp] = lcaccID;
						instance->allocatedAcceleratorCount__DispMapFindDisp++;
					}
					break;
				default:
					return ErrorHandler_sig__DispMapFindDispLCacc;
			...
			if(instance->allocatedAcceleratorCount__DispMapFindDisp == 1)
			{
				return StartEverythingHandler_sig__DispMapFindDispLCacc;
			}
			else
			{
				return 0;
...
inline void Cleanup_sig__DispMapFindDispLCacc(InstanceData_sig__DispMapFindDispLCacc* instance)
{
	...
	if(instance->allocatedAcceleratorIDSet__DispMapFindDisp[0] != 0)
	{
...
inline void StopEverythingHandler_sig__DispMapFindDispLCacc(InstanceData_sig__DispMapFindDispLCacc* instance)
{
	Cleanup_sig__DispMapFindDispLCacc(instance);
}
inline void ErrorHandler_sig__DispMapFindDispLCacc(InstanceData_sig__DispMapFindDispLCacc* instance)
{
	Cleanup_sig__DispMapFindDispLCacc(instance);
...
inline void (*ProgressHandler_sig__DispMapFindDispLCacc__sa(InstanceData_sig__DispMapFindDispLCacc* instance, InterruptArgs* args))(InstanceData_sig__DispMapFindDispLCacc*)
{
	switch(args->status)
	{
		...
		case(LCACC_STATUS_COMPLETED):
			...
			{
				return StopEverythingHandler_sig__DispMapFindDispLCacc;
			}
			else
			{
				return 0;
...
inline void StartEverythingHandler_sig__DispMapFindDispLCacc(InstanceData_sig__DispMapFindDispLCacc* instance)
{
	...
	instance->HandlerArgs__sa.lcaccID = instance->allocatedAcceleratorIDSet__DispMapFindDisp[0];
	...
	instance->HandlerArgs__sa.lcaccMode = LCACC_CLASS_SIG__DispMapFindDispLCacc__sa;
	...
	Wait_sig__DispMapFindDispLCacc(instance);// wait for everything to finish
}
inline void CreateBuffer_DispMapFindDispLCacc_sig(int thread, InstanceData_sig__DispMapFindDispLCacc* instance, float (*in_imgIntegral), float (*out_Disp), int dataSize, int nRows, int nCols, int SHIFT, int WIN, int chunk1, int chunk2, int chunk3, int chunk4)
{
	...
	instance->node_sa.SetSPMConfig((sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)), 3, 0);
	instance->LCAcc_FuncArgs__in_imgIntegral = in_imgIntegral;
	instance->LCAcc_FuncArgs__out_Disp = out_Disp;
	...
	instance->LCAcc_FuncVars__WIN = WIN;
	...
	instance->allocatedAcceleratorCount__DispMapFindDisp = 0;
	LCAccNode& VNR_vardecl_0(instance->node_sa);
	void* VNR_vardecl_1(instance->LCAcc_FuncArgs__in_imgIntegral);
	void* VNR_vardecl_2(instance->LCAcc_FuncArgs__out_Disp);
	...
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_7(((sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4))) + ((((0) * (sizeof(float) * (chunk2) * (chunk3) * (chunk4))) + ((0) * (sizeof(float) * (chunk3) * (chunk4))) + ((0) * (sizeof(float) * (chunk4))) + ((0) * (sizeof(float))))), sizeof(float), VNR_vardecl_3, VNR_vardecl_4);
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_8(((sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4))) + ((((0) * (sizeof(float) * (chunk2) * (chunk3) * (chunk4))) + ((0) * (sizeof(float) * (chunk3) * (chunk4))) + ((0) * (sizeof(float) * (chunk4))) + ((0) * (sizeof(float))))), sizeof(float), VNR_vardecl_3, VNR_vardecl_4);
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_9(((sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4))) + ((((0) * (sizeof(float) * (chunk2) * (chunk3) * (chunk4))) + ((0) * (sizeof(float) * (chunk3) * (chunk4))) + ((0) * (sizeof(float) * (chunk4))) + ((0) * (sizeof(float))))), sizeof(float), VNR_vardecl_3, VNR_vardecl_4);
	std::vector<MicroprogramWriter::ComputeArgIndex> VNR_vardecl_10;
	VNR_vardecl_10.push_back(VNR_vardecl_5);
	VNR_vardecl_10.push_back(VNR_vardecl_6);
	VNR_vardecl_10.push_back(VNR_vardecl_7);
	VNR_vardecl_10.push_back(VNR_vardecl_8);
	VNR_vardecl_10.push_back(VNR_vardecl_9);
	std::vector<uint64_t> VNR_vardecl_11;
	VNR_vardecl_11.push_back(ConvertToType<float, uint64_t>(0)/*Register internal_min*/);
	VNR_vardecl_11.push_back(ConvertToType<float, uint64_t>(0)/*Register internal_index*/);
	std::vector<uint32_t> VNR_vardecl_12;
	VNR_vardecl_12.push_back(((dataSize) - (0)) / (chunk1));
	VNR_vardecl_12.push_back(((SHIFT) - (0)) / (chunk2));
	VNR_vardecl_12.push_back(((nRows) - (0)) / (chunk3));
	VNR_vardecl_12.push_back(((nCols) - (0)) / (chunk4));
	std::vector<int32_t> VNR_vardecl_13;
	VNR_vardecl_13.push_back((chunk1) * ((sizeof(float) * (SHIFT) * (nRows + WIN) * (nCols + WIN))));
	VNR_vardecl_13.push_back((chunk2) * ((sizeof(float) * (nRows + WIN) * (nCols + WIN))));
	VNR_vardecl_13.push_back((chunk3) * ((sizeof(float) * (nCols + WIN))));
	VNR_vardecl_13.push_back((chunk4) * ((sizeof(float))));
	std::vector<int32_t> VNR_vardecl_14;
	VNR_vardecl_14.push_back((1) * ((sizeof(float) * (SHIFT) * (nRows + WIN) * (nCols + WIN))));
	VNR_vardecl_14.push_back((1) * ((sizeof(float) * (nRows + WIN) * (nCols + WIN))));
	VNR_vardecl_14.push_back((1) * ((sizeof(float) * (nCols + WIN))));
	VNR_vardecl_14.push_back((1) * ((sizeof(float))));
	std::vector<int32_t> VNR_vardecl_15;
	VNR_vardecl_15.push_back((1) * ((sizeof(float)) * (chunk2) * (chunk3) * (chunk4)));
	VNR_vardecl_15.push_back((1) * ((sizeof(float)) * (chunk3) * (chunk4)));
	VNR_vardecl_15.push_back((1) * ((sizeof(float)) * (chunk4)));
	VNR_vardecl_15.push_back((1) * ((sizeof(float))));
	std::vector<int32_t> VNR_vardecl_16;
	VNR_vardecl_16.push_back((chunk1) * ((sizeof(float) * (SHIFT) * (nRows) * (nCols))));
	VNR_vardecl_16.push_back((chunk2) * ((sizeof(float) * (nRows) * (nCols))));
	VNR_vardecl_16.push_back((chunk3) * ((sizeof(float) * (nCols))));
	VNR_vardecl_16.push_back((chunk4) * ((sizeof(float))));
	std::vector<int32_t> VNR_vardecl_17;
	VNR_vardecl_17.push_back((1) * ((sizeof(float) * (SHIFT) * (nRows) * (nCols))));
	VNR_vardecl_17.push_back((1) * ((sizeof(float) * (nRows) * (nCols))));
	VNR_vardecl_17.push_back((1) * ((sizeof(float) * (nCols))));
	...
	instance->acceleratorSignature__sa.AddCompute(VNR_vardecl_0, VNR_vardecl_10, VNR_vardecl_11);
	//produce transfer set
	//transfer from in_imgIntegral to sa
	...
	instance->acceleratorSignature__sa.AddTransfer(VNR_vardecl_1, VNR_vardecl_12, VNR_vardecl_13, VNR_vardecl_3, VNR_vardecl_14, VNR_vardecl_0, (0) + ((((0) * ((sizeof(float)) * (chunk2) * (chunk3) * (chunk4))) + ((0) * ((sizeof(float)) * (chunk3) * (chunk4))) + ((0) * ((sizeof(float)) * (chunk4))) + ((0) * ((sizeof(float)))))), VNR_vardecl_3, VNR_vardecl_15, sizeof(float));
	//transfer from in_imgIntegral to sa
	//Search VNR_vardecl_12 for source block size.
	//Search VNR_vardecl_13 for source block stride.
	//Search VNR_vardecl_3 for source element size.
	...
	//Search VNR_vardecl_3 for destination size.
	//Search VNR_vardecl_15 for destination stride.
	instance->acceleratorSignature__sa.AddTransfer(VNR_vardecl_1, VNR_vardecl_12, VNR_vardecl_13, VNR_vardecl_3, VNR_vardecl_14, VNR_vardecl_0, ((sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4))) + ((((0) * ((sizeof(float)) * (chunk2) * (chunk3) * (chunk4))) + ((0) * ((sizeof(float)) * (chunk3) * (chunk4))) + ((0) * ((sizeof(float)) * (chunk4))) + ((0) * ((sizeof(float)))))), VNR_vardecl_3, VNR_vardecl_15, sizeof(float));
	//transfer from in_imgIntegral to sa
	//Search VNR_vardecl_12 for source block size.
	//Search VNR_vardecl_13 for source block stride.
	//Search VNR_vardecl_3 for source element size.
	...
	//Search VNR_vardecl_15 for destination stride.
	instance->acceleratorSignature__sa.AddTransfer(VNR_vardecl_1, VNR_vardecl_12, VNR_vardecl_13, VNR_vardecl_3, VNR_vardecl_14, VNR_vardecl_0, ((sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4))) + ((((0) * ((sizeof(float)) * (chunk2) * (chunk3) * (chunk4))) + ((0) * ((sizeof(float)) * (chunk3) * (chunk4))) + ((0) * ((sizeof(float)) * (chunk4))) + ((0) * ((sizeof(float)))))), VNR_vardecl_3, VNR_vardecl_15, sizeof(float));
	//transfer from sa to out_Disp
	//Search VNR_vardecl_3 for source size.
	//Search VNR_vardecl_15 for source stride.
	//Search VNR_vardecl_12 for destination block size.
	...
	instance->acceleratorSignature__sa.AddTransfer(VNR_vardecl_0, ((sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4))) + ((((0) * ((sizeof(float)) * (chunk2) * (chunk3) * (chunk4))) + ((0) * ((sizeof(float)) * (chunk3) * (chunk4))) + ((0) * ((sizeof(float)) * (chunk4))) + ((0) * ((sizeof(float)))))), VNR_vardecl_3, VNR_vardecl_15, VNR_vardecl_2, VNR_vardecl_12, VNR_vardecl_16, VNR_vardecl_3, VNR_vardecl_17, sizeof(float));
	instance->acceleratorSignature__sa.Finalize((((dataSize) - (0)) / (chunk1)) * (((SHIFT) - (0)) / (chunk2)) * (((nRows) - (0)) / (chunk3)) * (((nCols) - (0)) / (chunk4)));
}
inline void DispMapFindDispLCacc_sig_buf(int threadID, InstanceData_sig__DispMapFindDispLCacc* instance)
{
	instance->Reset();
	LWI_RegisterInterruptHandler(&(instance->GAM_INTERACTION));
	LCAcc_Request(threadID, 832, 1);//request something of type AcceleratorType
	Wait_sig__DispMapFindDispLCacc(instance);// wait for everything to finish
}
inline void DispMapFindDispLCacc_sig(int threadID, float (*in_imgIntegral), float (*out_Disp), int dataSize, int nRows, int nCols, int SHIFT, int WIN, int chunk1, int chunk2, int chunk3, int chunk4)
{
	InstanceData_sig__DispMapFindDispLCacc instance;
	CreateBuffer_DispMapFindDispLCacc_sig(threadID, &instance, in_imgIntegral, out_Disp, dataSize, nRows, nCols, SHIFT, WIN, chunk1, chunk2, chunk3, chunk4);
	DispMapFindDispLCacc_sig_buf(threadID, &instance);
}
class BiN_DispMapFindDispLCacc_Arbitrator_sig
{
	std::vector<InstanceData_sig__DispMapFindDispLCacc*> instanceSet;
	...
	InterruptArgs isr;
public:
	inline BiN_DispMapFindDispLCacc_Arbitrator_sig(int thread)
	{
		ops.push_back(832);
		count.push_back(1);
		threadID = thread;
	}
	inline void AddConfig(InstanceData_sig__DispMapFindDispLCacc* inst, uint32_t performance, uint32_t cacheMod)
	{
	...
	inline void Run()
	{
		...
		int allocatedAcceleratorCount__DispMapFindDisp = 0;
		LCAcc_Request(threadID, 832, 1);//request something of type AcceleratorType
		bool cont = true;
				...
				case(LCACC_GAM_GRANT):
					{
						...
						{
							case(832):
								simics_assert(allocatedAcceleratorCount__DispMapFindDisp < 1);
								allocatedAcceleratorIDSet__DispMapFindDisp[allocatedAcceleratorCount__DispMapFindDisp] = lcaccID;
								allocatedAcceleratorCount__DispMapFindDisp++;
								break;
							default:
								simics_assert(0);
						}
						if(allocatedAcceleratorCount__DispMapFindDisp == 1)
						{
							cont = false;
						}
					}
		...
		InstanceData_sig__DispMapFindDispLCacc* inst = NULL;
		for(size_t i = 0; i < instanceSet.size(); i++)
		{
		...
		for(int i = 0; i < 1; i++)
		{
			inst->allocatedAcceleratorIDSet__DispMapFindDisp[i] = allocatedAcceleratorIDSet__DispMapFindDisp[i];
		}
		inst->allocatedAcceleratorCount__DispMapFindDisp = allocatedAcceleratorCount__DispMapFindDisp;
		inst->pendingAccelerators = 1;
		StartEverythingHandler_sig__DispMapFindDispLCacc(inst);
	}
};

#endif
#ifndef LCACC_BODY_TD__DispMapFindDispLCacc__X
#define LCACC_BODY_TD__DispMapFindDispLCacc__X

inline void Wait_td__DispMapFindDispLCacc(int thread)
{
...
inline void CreateBuffer_DispMapFindDispLCacc_td(uint8_t** buffer, uint32_t* bufferSize, uint8_t** constCluster, int thread, float (*in_imgIntegral), float (*out_Disp), int dataSize, int nRows, int nCols, int SHIFT, int WIN, int chunk1, int chunk2, int chunk3, int chunk4)
{
	simics_assert(dataSize > 0);
	simics_assert(nRows > 0);
	simics_assert(nCols > 0);
	...
	void* LCAcc_FuncArgs__in_imgIntegral = in_imgIntegral;
	void* LCAcc_FuncArgs__out_Disp = out_Disp;
	{
		void* VNR_vardecl_0(in_imgIntegral);
		void* VNR_vardecl_1(out_Disp);
		LCAccNode VNR_vardecl_2(832, (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)), 3, 0, 0);
		std::vector<uint32_t> VNR_vardecl_3;
		VNR_vardecl_3.push_back(((chunk1) - (0)) / (1));
		VNR_vardecl_3.push_back(((chunk2) - (0)) / (1));
		VNR_vardecl_3.push_back(((chunk3) - (0)) / (1));
		...
		//See VNR_vardecl_10 for index variable decl
		//See VNR_vardecl_11 for register set decl
		mw.AddCompute(VNR_vardecl_2, VNR_vardecl_10, VNR_vardecl_11);
		...
		//Search VNR_vardecl_3 for destination size.
		//Search VNR_vardecl_15 for destination stride.
		mw.AddTransfer(VNR_vardecl_0, VNR_vardecl_12, VNR_vardecl_13, VNR_vardecl_3, VNR_vardecl_14, VNR_vardecl_2, (0) + ((((0) * ((sizeof(float)) * (chunk2) * (chunk3) * (chunk4))) + ((0) * ((sizeof(float)) * (chunk3) * (chunk4))) + ((0) * ((sizeof(float)) * (chunk4))) + ((0) * ((sizeof(float)))))), VNR_vardecl_3, VNR_vardecl_15, sizeof(float));
		...
		//Search VNR_vardecl_3 for destination size.
		//Search VNR_vardecl_15 for destination stride.
		mw.AddTransfer(VNR_vardecl_0, VNR_vardecl_12, VNR_vardecl_13, VNR_vardecl_3, VNR_vardecl_14, VNR_vardecl_2, ((sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4))) + ((((0) * ((sizeof(float)) * (chunk2) * (chunk3) * (chunk4))) + ((0) * ((sizeof(float)) * (chunk3) * (chunk4))) + ((0) * ((sizeof(float)) * (chunk4))) + ((0) * ((sizeof(float)))))), VNR_vardecl_3, VNR_vardecl_15, sizeof(float));
		...
		//Search VNR_vardecl_3 for destination size.
		//Search VNR_vardecl_15 for destination stride.
		mw.AddTransfer(VNR_vardecl_0, VNR_vardecl_12, VNR_vardecl_13, VNR_vardecl_3, VNR_vardecl_14, VNR_vardecl_2, ((sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4))) + ((((0) * ((sizeof(float)) * (chunk2) * (chunk3) * (chunk4))) + ((0) * ((sizeof(float)) * (chunk3) * (chunk4))) + ((0) * ((sizeof(float)) * (chunk4))) + ((0) * ((sizeof(float)))))), VNR_vardecl_3, VNR_vardecl_15, sizeof(float));
		...
		//Search VNR_vardecl_3 for destination element size.
		//Search VNR_vardecl_17 for destination element stride.
		mw.AddTransfer(VNR_vardecl_2, ((sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4)) + (sizeof(float) * (chunk1) * (chunk2) * (chunk3) * (chunk4))) + ((((0) * ((sizeof(float)) * (chunk2) * (chunk3) * (chunk4))) + ((0) * ((sizeof(float)) * (chunk3) * (chunk4))) + ((0) * ((sizeof(float)) * (chunk4))) + ((0) * ((sizeof(float)))))), VNR_vardecl_3, VNR_vardecl_15, VNR_vardecl_1, VNR_vardecl_12, VNR_vardecl_16, VNR_vardecl_3, VNR_vardecl_17, sizeof(float));
...
inline void DispMapFindDispLCacc_td_buf(uint8_t* buf, uint32_t bufSize, int thread)
{
	...
	Wait_td__DispMapFindDispLCacc(thread);// wait for everything to finish
}
void DispMapFindDispLCacc_td(int thread, float (*in_imgIntegral), float (*out_Disp), int dataSize, int nRows, int nCols, int SHIFT, int WIN, int chunk1, int chunk2, int chunk3, int chunk4)
{
	uint32_t bufSize;
	uint8_t* buffer;
	uint8_t* constCluster = NULL;
	CreateBuffer_DispMapFindDispLCacc_td(&buffer, &bufSize, &constCluster, thread, in_imgIntegral, out_Disp, dataSize, nRows, nCols, SHIFT, WIN, chunk1, chunk2, chunk3, chunk4);
	DispMapFindDispLCacc_td_buf(buffer, bufSize, thread);
	if(constCluster)
	{
		delete [] constCluster;
	}
...
inline uint32_t DispMapFindDispLCacc_CalculateBiNSize(int dataSize, int nRows, int nCols, int SHIFT, int WIN, int chunk1, int chunk2, int chunk3, int chunk4)
{
	return 0;
}
class BiN_DispMapFindDispLCacc_Arbitrator_td
{
	...
	InterruptArgs isr;
public:
	inline BiN_DispMapFindDispLCacc_Arbitrator_td(){}
	...
	inline void Run(int threadID)
	{
		...
		isr.lcaccID = 0;
		isr.lcaccMode = 0;
		LCAcc_DeclareLCAccUse(threadID, 832, 1); //requests for DispMapFindDisp
		...
		for(size_t i = 0; i < binSizeSet.size(); i++)
		{
			...
			{
				DispMapFindDispLCacc_td_buf(bufSet[i], bufSizeSet[i], threadID);
				return;
			}
		}
		simics_assert(0);
