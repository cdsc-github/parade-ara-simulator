...
void TDLCA_Registration::Initialize(int threadID, int procID)
{
        thread = threadID;
	...
	CreateBuffer_Blur1LCacc_td(&buf1, &buf1Size, &constCluster1, thread, vSet, vSet, 3, dataSize, dataSize, dataSize, 0.20f, 1, 2, dataSize);
	CreateBuffer_Blur2LCacc_td(&buf2, &buf2Size, &constCluster2, thread, vSet, vSet, 3, dataSize, dataSize, dataSize, 0.20f, 1, 2, dataSize);
	CreateBuffer_Blur3LCacc_td(&buf3, &buf3Size, &constCluster3, thread, vSet, vSet, 3, dataSize, dataSize, dataSize, 0.20f, 1, 2, dataSize);
	CreateBuffer_Registration1LCacc_td(&buf4, &buf4Size, &constCluster4, thread, vSet, vSet + (dataSize * dataSize * dataSize), vSet + (dataSize * dataSize * dataSize * 2), u1, u2, u3, result_1, result_2, result_3, dataSize, dataSize, dataSize, 8, 8, 8);
...
void TDLCA_Registration::Shutdown()
{
        while(true);
}
