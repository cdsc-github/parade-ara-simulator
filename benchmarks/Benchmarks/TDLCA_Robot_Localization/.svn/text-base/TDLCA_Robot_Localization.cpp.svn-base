...
/*		ran1[z][0][0] = (-2.0 * log(0.9)) / 9;
	...
	CreateBuffer_RobLocLCacc_td(&buf1, &bufSize1, &constCluster1, thread, (float (*)[3])ran1, (float (*)[3])ran2, (float (*)[4])quat, (float (*)[3])accl, (float (*)[3])pos_in, (float (*)[3])vel_in, (float (*)[3])pos_out, (float (*)[3])vel_out, dataSize, N_VAL, 128, N_VAL);
}
