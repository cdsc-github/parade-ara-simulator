...
void TDLCA_Segmentation::Initialize(int threadID, int procID)
{
	...
	CreateBuffer_Segmentation1LCacc_td(&buf, &bufSize, &constCluster, thread, phi, u0, result, dataSize, dataSize, dataSize, 8, 8, 8, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f);
