...
#endif
#ifndef LCACC_BODY_SIG__StreamCluster3LCacc__X
#define LCACC_BODY_SIG__StreamCluster3LCacc__X
#define LCACC_CLASS_SIG__StreamCluster3LCacc__x 1
class InstanceData_sig__StreamCluster3LCacc
{
public:
	...
	int allocatedAcceleratorCount__streamCluster3;
	int allocatedAcceleratorIDSet__streamCluster3[1];
	float LCAcc_FuncConstVals__constant0[32];
	float (*LCAcc_FuncArgs__point)[32];
	float (*LCAcc_FuncArgs__weight);
	float (*LCAcc_FuncArgs__cost);
	uint32_t (*LCAcc_FuncArgs__assign);
	uint32_t (*LCAcc_FuncArgs__in_switch_membership);
	uint32_t (*LCAcc_FuncArgs__out_switch_membership);
	uint64_t LCAcc_FuncVars__center;
	uint64_t LCAcc_FuncVars__lower;
	...
	inline void Reset()
	{
		...
		allocatedAcceleratorCount__streamCluster3 = 0;
		reservedAccelerators = 0;
		allocatedAcceleratorIDSet__streamCluster3[0] = 0;
		HandlerArgs__x.threadID = threadID;
		HandlerArgs__x.status = 0;
		HandlerArgs__x.taskIndex = 0;
		HandlerArgs__x.lcaccMode = LCACC_CLASS_SIG__StreamCluster3LCacc__x;
		node_x.Reset();
	}
	inline InstanceData_sig__StreamCluster3LCacc() :
...
inline void (*GAMHandler_sig__StreamCluster3LCacc(InstanceData_sig__StreamCluster3LCacc* instance, InterruptArgs* args))(InstanceData_sig__StreamCluster3LCacc*) ;
inline void Cleanup_sig__StreamCluster3LCacc(InstanceData_sig__StreamCluster3LCacc* instance);
inline void StartEverythingHandler_sig__StreamCluster3LCacc(InstanceData_sig__StreamCluster3LCacc* instance);
inline void StopEverythingHandler_sig__StreamCluster3LCacc(InstanceData_sig__StreamCluster3LCacc* instance);
inline void ErrorHandler_sig__StreamCluster3LCacc(InstanceData_sig__StreamCluster3LCacc* instance);
inline void Wait_sig__StreamCluster3LCacc(InstanceData_sig__StreamCluster3LCacc* instance);
inline unsigned int DelayEstimate_sig__StreamCluster3LCacc(int vectorSize)
{
	return 1;
}
inline void (*ProgressHandler_sig__StreamCluster3LCacc__x(InstanceData_sig__StreamCluster3LCacc* instance, InterruptArgs* args))(InstanceData_sig__StreamCluster3LCacc*);
//This is a procedurally generated interrupt-based program from a RAGraph data structure for function StreamCluster3LCacc
inline void Wait_sig__StreamCluster3LCacc(InstanceData_sig__StreamCluster3LCacc* instance)
{
	while(1)
	{
		...
		InterruptArgs* args = 0;
		void (*progress)(InstanceData_sig__StreamCluster3LCacc*);
		while((args = LWI_CheckInterrupt(thread)) == 0);
		switch(args->lcaccMode)
		{
			case(0):
				progress = GAMHandler_sig__StreamCluster3LCacc(instance, args);
				break;
			case(LCACC_CLASS_SIG__StreamCluster3LCacc__x):
				progress = ProgressHandler_sig__StreamCluster3LCacc__x(instance, args);
				break;
			default:
				ErrorHandler_sig__StreamCluster3LCacc(instance);
				simics_assert(0);
		}
	...
	switch(args->status)
	{
		case(LCACC_GAM_WAIT):
			...
			if(instance->reservedAccelerators == 1)
			{
				...
				LCAcc_Reserve(args->threadID, 0, DelayEstimate_sig__StreamCluster3LCacc(instance->acceleratorVectorLength));
			}
			return 0;
			break;
		case(LCACC_GAM_GRANT):
			...
			{
				case(1203):
					if(instance->allocatedAcceleratorCount__streamCluster3 == 1)
					{
						return ErrorHandler_sig__StreamCluster3LCacc;
					}
					else
					{
						instance->pendingAccelerators++;
						instance->allocatedAcceleratorIDSet__streamCluster3[instance->allocatedAcceleratorCount__streamCluster3] = lcaccID;
						instance->allocatedAcceleratorCount__streamCluster3++;
					}
					break;
				default:
					return ErrorHandler_sig__StreamCluster3LCacc;
			...
			if(instance->allocatedAcceleratorCount__streamCluster3 == 1)
			{
				return StartEverythingHandler_sig__StreamCluster3LCacc;
			}
			else
			{
				return 0;
...
inline void Cleanup_sig__StreamCluster3LCacc(InstanceData_sig__StreamCluster3LCacc* instance)
{
	...
	if(instance->allocatedAcceleratorIDSet__streamCluster3[0] != 0)
	{
...
inline void StopEverythingHandler_sig__StreamCluster3LCacc(InstanceData_sig__StreamCluster3LCacc* instance)
{
	Cleanup_sig__StreamCluster3LCacc(instance);
}
inline void ErrorHandler_sig__StreamCluster3LCacc(InstanceData_sig__StreamCluster3LCacc* instance)
{
	Cleanup_sig__StreamCluster3LCacc(instance);
...
inline void (*ProgressHandler_sig__StreamCluster3LCacc__x(InstanceData_sig__StreamCluster3LCacc* instance, InterruptArgs* args))(InstanceData_sig__StreamCluster3LCacc*)
{
	switch(args->status)
	{
		...
		case(LCACC_STATUS_COMPLETED):
			...
			{
				return StopEverythingHandler_sig__StreamCluster3LCacc;
			}
			else
			{
				return 0;
...
inline void StartEverythingHandler_sig__StreamCluster3LCacc(InstanceData_sig__StreamCluster3LCacc* instance)
{
	...
	instance->HandlerArgs__x.lcaccID = instance->allocatedAcceleratorIDSet__streamCluster3[0];
	...
	instance->HandlerArgs__x.lcaccMode = LCACC_CLASS_SIG__StreamCluster3LCacc__x;
	...
	Wait_sig__StreamCluster3LCacc(instance);// wait for everything to finish
}
inline void CreateBuffer_StreamCluster3LCacc_sig(int thread, InstanceData_sig__StreamCluster3LCacc* instance, float (*point)[32], float (*weight), float (*cost), uint32_t (*assign), uint32_t (*in_switch_membership), uint32_t (*out_switch_membership), uint64_t center, uint64_t lower, float xPoint[32], int size, int chunk)
{
	int index, i;
	...
	instance->node_x.SetSPMConfig((sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1)) + (sizeof(float) * (chunk)) + (sizeof(float) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(float) * (chunk)) + (sizeof(uint32_t) * (chunk)), 3, 0);
	...
	instance->LCAcc_FuncArgs__cost = cost;
	instance->LCAcc_FuncArgs__assign = assign;
	instance->LCAcc_FuncArgs__in_switch_membership = in_switch_membership;
	instance->LCAcc_FuncArgs__out_switch_membership = out_switch_membership;
	instance->LCAcc_FuncVars__center = center;
	instance->LCAcc_FuncVars__lower = lower;
	...
	instance->allocatedAcceleratorCount__streamCluster3 = 0;
	LCAccNode& VNR_vardecl_0(instance->node_x);
	void* VNR_vardecl_1(instance->LCAcc_FuncArgs__point);
	void* VNR_vardecl_2(&(instance->LCAcc_FuncConstVals__constant0));
	void* VNR_vardecl_3(instance->LCAcc_FuncArgs__weight);
	void* VNR_vardecl_4(instance->LCAcc_FuncArgs__cost);
	void* VNR_vardecl_5(instance->LCAcc_FuncArgs__assign);
	void* VNR_vardecl_6(instance->LCAcc_FuncArgs__in_switch_membership);
	void* VNR_vardecl_7(instance->LCAcc_FuncArgs__out_switch_membership);
	std::vector<uint32_t> VNR_vardecl_8;
	VNR_vardecl_8.push_back(((chunk) - (0)) / (1));
	std::vector<int32_t> VNR_vardecl_9;
	VNR_vardecl_9.push_back((1) * (sizeof(float[32])));
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_10((0) + ((((0) * (sizeof(float[32]))))), sizeof(float), VNR_vardecl_8, VNR_vardecl_9);
	std::vector<uint32_t> VNR_vardecl_11;
	VNR_vardecl_11.push_back(((1) - (0)) / (1));
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_12(((sizeof(float[32]) * (chunk))) + ((((0) * (sizeof(float[32]))))), sizeof(float), VNR_vardecl_11, VNR_vardecl_9);
	std::vector<int32_t> VNR_vardecl_13;
	VNR_vardecl_13.push_back((1) * (sizeof(float)));
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_14(((sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1))) + ((((0) * (sizeof(float))))), sizeof(float), VNR_vardecl_8, VNR_vardecl_13);
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_15(((sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1)) + (sizeof(float) * (chunk))) + ((((0) * (sizeof(float))))), sizeof(float), VNR_vardecl_8, VNR_vardecl_13);
	std::vector<int32_t> VNR_vardecl_16;
	VNR_vardecl_16.push_back((1) * (sizeof(uint32_t)));
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_17(((sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1)) + (sizeof(float) * (chunk)) + (sizeof(float) * (chunk))) + ((((0) * (sizeof(uint32_t))))), sizeof(uint32_t), VNR_vardecl_8, VNR_vardecl_16);
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_18(((sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1)) + (sizeof(float) * (chunk)) + (sizeof(float) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk))) + ((((0) * (sizeof(uint32_t))))), sizeof(uint32_t), VNR_vardecl_8, VNR_vardecl_16);
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_19(((sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1)) + (sizeof(float) * (chunk)) + (sizeof(float) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(float) * (chunk))) + ((((0) * (sizeof(uint32_t))))), sizeof(uint32_t), VNR_vardecl_8, VNR_vardecl_16);
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_20(((sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1)) + (sizeof(float) * (chunk)) + (sizeof(float) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk))) + ((((0) * (sizeof(uint32_t))))), sizeof(uint32_t), VNR_vardecl_8, VNR_vardecl_16);
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_21(((sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1)) + (sizeof(float) * (chunk)) + (sizeof(float) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk))) + ((((0) * (sizeof(float))))), sizeof(float), VNR_vardecl_8, VNR_vardecl_13);
	std::vector<MicroprogramWriter::ComputeArgIndex> VNR_vardecl_22;
	VNR_vardecl_22.push_back(VNR_vardecl_10);
	VNR_vardecl_22.push_back(VNR_vardecl_12);
	VNR_vardecl_22.push_back(VNR_vardecl_14);
	VNR_vardecl_22.push_back(VNR_vardecl_15);
	VNR_vardecl_22.push_back(VNR_vardecl_17);
	VNR_vardecl_22.push_back(VNR_vardecl_18);
	VNR_vardecl_22.push_back(VNR_vardecl_19);
	VNR_vardecl_22.push_back(VNR_vardecl_20);
	VNR_vardecl_22.push_back(VNR_vardecl_21);
	std::vector<uint64_t> VNR_vardecl_23;
	VNR_vardecl_23.push_back(ConvertToType<uint64_t, uint64_t>(center)/*Register tableAddr*/);
	VNR_vardecl_23.push_back(ConvertToType<uint32_t, uint64_t>(sizeof(uint32_t))/*Register tableStride*/);
	VNR_vardecl_23.push_back(ConvertToType<uint64_t, uint64_t>(((sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1)) + (sizeof(float) * (chunk)) + (sizeof(float) * (chunk)) + (sizeof(uint32_t) * (chunk))))/*Register spmAddr*/);
	VNR_vardecl_23.push_back(ConvertToType<uint64_t, uint64_t>(lower)/*Register lowerAddr*/);
	VNR_vardecl_23.push_back(ConvertToType<uint32_t, uint64_t>(sizeof(float))/*Register lowerStride*/);
	VNR_vardecl_23.push_back(ConvertToType<uint64_t, uint64_t>(((sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1)) + (sizeof(float) * (chunk)) + (sizeof(float) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk))))/*Register modificationAddr*/);
	std::vector<uint32_t> VNR_vardecl_24;
	VNR_vardecl_24.push_back(((size) - (0)) / (chunk));
	std::vector<int32_t> VNR_vardecl_25;
	VNR_vardecl_25.push_back((chunk) * ((sizeof(float[32]))));
	std::vector<uint32_t> VNR_vardecl_26;
	VNR_vardecl_26.push_back(((chunk) - (0)) / (1));
	VNR_vardecl_26.push_back((32));
	std::vector<int32_t> VNR_vardecl_27;
	VNR_vardecl_27.push_back((1) * ((sizeof(float[32]))));
	VNR_vardecl_27.push_back((sizeof(float)));
	std::vector<uint32_t> VNR_vardecl_28;
	VNR_vardecl_28.push_back((1));
	std::vector<int32_t> VNR_vardecl_29;
	VNR_vardecl_29.push_back((0));
	std::vector<uint32_t> VNR_vardecl_30;
	VNR_vardecl_30.push_back((((((1) - (0)) / (1)) * ((32))) / (32)));
	VNR_vardecl_30.push_back(32);
	std::vector<int32_t> VNR_vardecl_31;
	VNR_vardecl_31.push_back((0));
	VNR_vardecl_31.push_back(sizeof(float));
	std::vector<uint32_t> VNR_vardecl_32;
	VNR_vardecl_32.push_back(((1) - (0)) / (1));
	VNR_vardecl_32.push_back((32));
	std::vector<int32_t> VNR_vardecl_33;
	VNR_vardecl_33.push_back((chunk) * ((sizeof(float))));
	std::vector<int32_t> VNR_vardecl_34;
	VNR_vardecl_34.push_back((1) * ((sizeof(float))));
	std::vector<int32_t> VNR_vardecl_35;
	VNR_vardecl_35.push_back((chunk) * ((sizeof(uint32_t))));
	std::vector<int32_t> VNR_vardecl_36;
	VNR_vardecl_36.push_back((1) * ((sizeof(uint32_t))));
	//produce compute set
	...
	//Search VNR_vardecl_26 for source element size.
	//Search VNR_vardecl_27 for source element stride.
	//Search VNR_vardecl_26 for destination size.
	//Search VNR_vardecl_27 for destination stride.
	instance->acceleratorSignature__x.AddTransfer(VNR_vardecl_1, VNR_vardecl_24, VNR_vardecl_25, VNR_vardecl_26, VNR_vardecl_27, VNR_vardecl_0, (0) + ((((0) * ((sizeof(float[32])))))), VNR_vardecl_26, VNR_vardecl_27, sizeof(float));
	//transfer from constant0 to x
	//Search VNR_vardecl_28 for source block size.
	//Search VNR_vardecl_29 for source block stride.
	//Search VNR_vardecl_30 for source element size.
	//Search VNR_vardecl_31 for source element stride.
	//Search VNR_vardecl_32 for destination size.
	//Search VNR_vardecl_27 for destination stride.
	instance->acceleratorSignature__x.AddTransfer(VNR_vardecl_2, VNR_vardecl_28, VNR_vardecl_29, VNR_vardecl_30, VNR_vardecl_31, VNR_vardecl_0, ((sizeof(float[32]) * (chunk))) + ((((0) * ((sizeof(float[32])))))), VNR_vardecl_32, VNR_vardecl_27, sizeof(float));
	//transfer from weight to x
	//Search VNR_vardecl_24 for source block size.
	//Search VNR_vardecl_33 for source block stride.
	//Search VNR_vardecl_8 for source element size.
	//Search VNR_vardecl_34 for source element stride.
	//Search VNR_vardecl_8 for destination size.
	//Search VNR_vardecl_34 for destination stride.
	instance->acceleratorSignature__x.AddTransfer(VNR_vardecl_3, VNR_vardecl_24, VNR_vardecl_33, VNR_vardecl_8, VNR_vardecl_34, VNR_vardecl_0, ((sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1))) + ((((0) * ((sizeof(float)))))), VNR_vardecl_8, VNR_vardecl_34, sizeof(float));
	//transfer from cost to x
	//Search VNR_vardecl_24 for source block size.
	//Search VNR_vardecl_33 for source block stride.
	//Search VNR_vardecl_8 for source element size.
	//Search VNR_vardecl_34 for source element stride.
	//Search VNR_vardecl_8 for destination size.
	//Search VNR_vardecl_34 for destination stride.
	instance->acceleratorSignature__x.AddTransfer(VNR_vardecl_4, VNR_vardecl_24, VNR_vardecl_33, VNR_vardecl_8, VNR_vardecl_34, VNR_vardecl_0, ((sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1)) + (sizeof(float) * (chunk))) + ((((0) * ((sizeof(float)))))), VNR_vardecl_8, VNR_vardecl_34, sizeof(float));
	//transfer from assign to x
	//Search VNR_vardecl_24 for source block size.
	//Search VNR_vardecl_35 for source block stride.
	//Search VNR_vardecl_8 for source element size.
	//Search VNR_vardecl_36 for source element stride.
	//Search VNR_vardecl_8 for destination size.
	//Search VNR_vardecl_36 for destination stride.
	instance->acceleratorSignature__x.AddTransfer(VNR_vardecl_5, VNR_vardecl_24, VNR_vardecl_35, VNR_vardecl_8, VNR_vardecl_36, VNR_vardecl_0, ((sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1)) + (sizeof(float) * (chunk)) + (sizeof(float) * (chunk))) + ((((0) * ((sizeof(uint32_t)))))), VNR_vardecl_8, VNR_vardecl_36, sizeof(uint32_t));
	//transfer from in_switch_membership to x
	//Search VNR_vardecl_24 for source block size.
	//Search VNR_vardecl_35 for source block stride.
	//Search VNR_vardecl_8 for source element size.
	//Search VNR_vardecl_36 for source element stride.
	//Search VNR_vardecl_8 for destination size.
	//Search VNR_vardecl_36 for destination stride.
	instance->acceleratorSignature__x.AddTransfer(VNR_vardecl_6, VNR_vardecl_24, VNR_vardecl_35, VNR_vardecl_8, VNR_vardecl_36, VNR_vardecl_0, ((sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1)) + (sizeof(float) * (chunk)) + (sizeof(float) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk))) + ((((0) * ((sizeof(uint32_t)))))), VNR_vardecl_8, VNR_vardecl_36, sizeof(uint32_t));
	//transfer from x to out_switch_membership
	//Search VNR_vardecl_8 for source size.
	//Search VNR_vardecl_36 for source stride.
	//Search VNR_vardecl_24 for destination block size.
	//Search VNR_vardecl_35 for destination block stride.
	//Search VNR_vardecl_8 for destination element size.
	//Search VNR_vardecl_36 for destination element stride.
	instance->acceleratorSignature__x.AddTransfer(VNR_vardecl_0, ((sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1)) + (sizeof(float) * (chunk)) + (sizeof(float) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk))) + ((((0) * ((sizeof(uint32_t)))))), VNR_vardecl_8, VNR_vardecl_36, VNR_vardecl_7, VNR_vardecl_24, VNR_vardecl_35, VNR_vardecl_8, VNR_vardecl_36, sizeof(uint32_t));
	instance->acceleratorSignature__x.Finalize((((size) - (0)) / (chunk)));
}
inline void StreamCluster3LCacc_sig_buf(int threadID, InstanceData_sig__StreamCluster3LCacc* instance)
{
	instance->Reset();
	LWI_RegisterInterruptHandler(&(instance->GAM_INTERACTION));
	LCAcc_Request(threadID, 1203, 1);//request something of type AcceleratorType
	Wait_sig__StreamCluster3LCacc(instance);// wait for everything to finish
}
inline void StreamCluster3LCacc_sig(int threadID, float (*point)[32], float (*weight), float (*cost), uint32_t (*assign), uint32_t (*in_switch_membership), uint32_t (*out_switch_membership), uint64_t center, uint64_t lower, float xPoint[32], int size, int chunk)
{
	InstanceData_sig__StreamCluster3LCacc instance;
	CreateBuffer_StreamCluster3LCacc_sig(threadID, &instance, point, weight, cost, assign, in_switch_membership, out_switch_membership, center, lower, xPoint, size, chunk);
	StreamCluster3LCacc_sig_buf(threadID, &instance);
}
class BiN_StreamCluster3LCacc_Arbitrator_sig
{
	std::vector<InstanceData_sig__StreamCluster3LCacc*> instanceSet;
	...
	InterruptArgs isr;
public:
	inline BiN_StreamCluster3LCacc_Arbitrator_sig(int thread)
	{
		ops.push_back(1203);
		count.push_back(1);
		threadID = thread;
	}
	inline void AddConfig(InstanceData_sig__StreamCluster3LCacc* inst, uint32_t performance, uint32_t cacheMod)
	{
	...
	inline void Run()
	{
		...
		int allocatedAcceleratorCount__streamCluster3 = 0;
		LCAcc_Request(threadID, 1203, 1);//request something of type AcceleratorType
		bool cont = true;
				...
				case(LCACC_GAM_GRANT):
					{
						...
						{
							case(1203):
								simics_assert(allocatedAcceleratorCount__streamCluster3 < 1);
								allocatedAcceleratorIDSet__streamCluster3[allocatedAcceleratorCount__streamCluster3] = lcaccID;
								allocatedAcceleratorCount__streamCluster3++;
								break;
							default:
								simics_assert(0);
						}
						if(allocatedAcceleratorCount__streamCluster3 == 1)
						{
							cont = false;
						}
					}
		...
		InstanceData_sig__StreamCluster3LCacc* inst = NULL;
		for(size_t i = 0; i < instanceSet.size(); i++)
		{
		...
		for(int i = 0; i < 1; i++)
		{
			inst->allocatedAcceleratorIDSet__streamCluster3[i] = allocatedAcceleratorIDSet__streamCluster3[i];
		}
		inst->allocatedAcceleratorCount__streamCluster3 = allocatedAcceleratorCount__streamCluster3;
		inst->pendingAccelerators = 1;
		StartEverythingHandler_sig__StreamCluster3LCacc(inst);
	}
};

#endif
#ifndef LCACC_BODY_TD__StreamCluster3LCacc__X
#define LCACC_BODY_TD__StreamCluster3LCacc__X

inline void Wait_td__StreamCluster3LCacc(int thread)
{
...
inline void CreateBuffer_StreamCluster3LCacc_td(uint8_t** buffer, uint32_t* bufferSize, uint8_t** constCluster, int thread, float (*point)[32], float (*weight), float (*cost), uint32_t (*assign), uint32_t (*in_switch_membership), uint32_t (*out_switch_membership), uint64_t center, uint64_t lower, float xPoint[32], int size, int chunk)
{
	MicroprogramWriter mw(false);
	void* LCAcc_FuncArgs__point = point;
	void* LCAcc_FuncArgs__weight = weight;
	void* LCAcc_FuncArgs__cost = cost;
	void* LCAcc_FuncArgs__assign = assign;
	void* LCAcc_FuncArgs__in_switch_membership = in_switch_membership;
	void* LCAcc_FuncArgs__out_switch_membership = out_switch_membership;
	*constCluster = new uint8_t[sizeof(float[32])];
	...
	memcpy(*LCAcc_FuncConst__constant0, xPoint, sizeof(float[32]));
	{
		...
		void* VNR_vardecl_2(weight);
		void* VNR_vardecl_3(cost);
		void* VNR_vardecl_4(assign);
		void* VNR_vardecl_5(in_switch_membership);
		void* VNR_vardecl_6(out_switch_membership);
		LCAccNode VNR_vardecl_7(1203, (sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1)) + (sizeof(float) * (chunk)) + (sizeof(float) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(float) * (chunk)) + (sizeof(uint32_t) * (chunk)), 3, 0, 0);
		std::vector<uint32_t> VNR_vardecl_8;
		VNR_vardecl_8.push_back(((chunk) - (0)) / (1));
		std::vector<int32_t> VNR_vardecl_9;
		VNR_vardecl_9.push_back((1) * (sizeof(float[32])));
		...
		//Search VNR_vardecl_26 for destination size.
		//Search VNR_vardecl_27 for destination stride.
		mw.AddTransfer(VNR_vardecl_1, VNR_vardecl_24, VNR_vardecl_25, VNR_vardecl_26, VNR_vardecl_27, VNR_vardecl_7, (0) + ((((0) * ((sizeof(float[32])))))), VNR_vardecl_26, VNR_vardecl_27, sizeof(float));
		...
		//Search VNR_vardecl_32 for destination size.
		//Search VNR_vardecl_27 for destination stride.
		mw.AddTransfer(VNR_vardecl_0, VNR_vardecl_28, VNR_vardecl_29, VNR_vardecl_30, VNR_vardecl_31, VNR_vardecl_7, ((sizeof(float[32]) * (chunk))) + ((((0) * ((sizeof(float[32])))))), VNR_vardecl_32, VNR_vardecl_27, sizeof(float));
		...
		//Search VNR_vardecl_8 for destination size.
		//Search VNR_vardecl_34 for destination stride.
		mw.AddTransfer(VNR_vardecl_2, VNR_vardecl_24, VNR_vardecl_33, VNR_vardecl_8, VNR_vardecl_34, VNR_vardecl_7, ((sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1))) + ((((0) * ((sizeof(float)))))), VNR_vardecl_8, VNR_vardecl_34, sizeof(float));
		...
		//Search VNR_vardecl_8 for destination size.
		//Search VNR_vardecl_34 for destination stride.
		mw.AddTransfer(VNR_vardecl_3, VNR_vardecl_24, VNR_vardecl_33, VNR_vardecl_8, VNR_vardecl_34, VNR_vardecl_7, ((sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1)) + (sizeof(float) * (chunk))) + ((((0) * ((sizeof(float)))))), VNR_vardecl_8, VNR_vardecl_34, sizeof(float));
		...
		//Search VNR_vardecl_8 for destination size.
		//Search VNR_vardecl_36 for destination stride.
		mw.AddTransfer(VNR_vardecl_4, VNR_vardecl_24, VNR_vardecl_35, VNR_vardecl_8, VNR_vardecl_36, VNR_vardecl_7, ((sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1)) + (sizeof(float) * (chunk)) + (sizeof(float) * (chunk))) + ((((0) * ((sizeof(uint32_t)))))), VNR_vardecl_8, VNR_vardecl_36, sizeof(uint32_t));
		...
		//Search VNR_vardecl_8 for destination size.
		//Search VNR_vardecl_36 for destination stride.
		mw.AddTransfer(VNR_vardecl_5, VNR_vardecl_24, VNR_vardecl_35, VNR_vardecl_8, VNR_vardecl_36, VNR_vardecl_7, ((sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1)) + (sizeof(float) * (chunk)) + (sizeof(float) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk))) + ((((0) * ((sizeof(uint32_t)))))), VNR_vardecl_8, VNR_vardecl_36, sizeof(uint32_t));
		...
		//Search VNR_vardecl_8 for destination element size.
		//Search VNR_vardecl_36 for destination element stride.
		mw.AddTransfer(VNR_vardecl_7, ((sizeof(float[32]) * (chunk)) + (sizeof(float[32]) * (1)) + (sizeof(float) * (chunk)) + (sizeof(float) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk))) + ((((0) * ((sizeof(uint32_t)))))), VNR_vardecl_8, VNR_vardecl_36, VNR_vardecl_6, VNR_vardecl_24, VNR_vardecl_35, VNR_vardecl_8, VNR_vardecl_36, sizeof(uint32_t));
...
inline void StreamCluster3LCacc_td_buf(uint8_t* buf, uint32_t bufSize, int thread)
{
	...
	Wait_td__StreamCluster3LCacc(thread);// wait for everything to finish
}
void StreamCluster3LCacc_td(int thread, float (*point)[32], float (*weight), float (*cost), uint32_t (*assign), uint32_t (*in_switch_membership), uint32_t (*out_switch_membership), uint64_t center, uint64_t lower, float xPoint[32], int size, int chunk)
{
	uint32_t bufSize;
	uint8_t* buffer;
	uint8_t* constCluster = NULL;
	CreateBuffer_StreamCluster3LCacc_td(&buffer, &bufSize, &constCluster, thread, point, weight, cost, assign, in_switch_membership, out_switch_membership, center, lower, xPoint, size, chunk);
	StreamCluster3LCacc_td_buf(buffer, bufSize, thread);
	if(constCluster)
	{
		delete [] constCluster;
	}
...
inline uint32_t StreamCluster3LCacc_CalculateBiNSize(uint64_t center, uint64_t lower, float xPoint[32], int size, int chunk)
{
	return 0;
}
class BiN_StreamCluster3LCacc_Arbitrator_td
{
	...
	InterruptArgs isr;
public:
	inline BiN_StreamCluster3LCacc_Arbitrator_td(){}
	...
	inline void Run(int threadID)
	{
		...
		isr.lcaccID = 0;
		isr.lcaccMode = 0;
		LCAcc_DeclareLCAccUse(threadID, 1203, 1); //requests for streamCluster3
		...
		for(size_t i = 0; i < binSizeSet.size(); i++)
		{
			...
			{
				StreamCluster3LCacc_td_buf(bufSet[i], bufSizeSet[i], threadID);
				return;
			}
		}
		simics_assert(0);
