...
#endif
#ifndef LCACC_BODY_SIG__StreamCluster6LCacc__X
#define LCACC_BODY_SIG__StreamCluster6LCacc__X
#define LCACC_CLASS_SIG__StreamCluster6LCacc__x 1
class InstanceData_sig__StreamCluster6LCacc
{
public:
	...
	int allocatedAcceleratorCount__streamCluster6;
	int allocatedAcceleratorIDSet__streamCluster6[1];
	uint32_t (*LCAcc_FuncArgs__inIsCenter);
	uint32_t (*LCAcc_FuncArgs__table);
	uint32_t (*LCAcc_FuncArgs__outIsCenter);
	...
	inline void Reset()
	{
		...
		allocatedAcceleratorCount__streamCluster6 = 0;
		reservedAccelerators = 0;
		allocatedAcceleratorIDSet__streamCluster6[0] = 0;
		HandlerArgs__x.threadID = threadID;
		HandlerArgs__x.status = 0;
		HandlerArgs__x.taskIndex = 0;
		HandlerArgs__x.lcaccMode = LCACC_CLASS_SIG__StreamCluster6LCacc__x;
		node_x.Reset();
	}
	inline InstanceData_sig__StreamCluster6LCacc() :
...
inline void (*GAMHandler_sig__StreamCluster6LCacc(InstanceData_sig__StreamCluster6LCacc* instance, InterruptArgs* args))(InstanceData_sig__StreamCluster6LCacc*) ;
inline void Cleanup_sig__StreamCluster6LCacc(InstanceData_sig__StreamCluster6LCacc* instance);
inline void StartEverythingHandler_sig__StreamCluster6LCacc(InstanceData_sig__StreamCluster6LCacc* instance);
inline void StopEverythingHandler_sig__StreamCluster6LCacc(InstanceData_sig__StreamCluster6LCacc* instance);
inline void ErrorHandler_sig__StreamCluster6LCacc(InstanceData_sig__StreamCluster6LCacc* instance);
inline void Wait_sig__StreamCluster6LCacc(InstanceData_sig__StreamCluster6LCacc* instance);
inline unsigned int DelayEstimate_sig__StreamCluster6LCacc(int vectorSize)
{
	return 1;
}
inline void (*ProgressHandler_sig__StreamCluster6LCacc__x(InstanceData_sig__StreamCluster6LCacc* instance, InterruptArgs* args))(InstanceData_sig__StreamCluster6LCacc*);
//This is a procedurally generated interrupt-based program from a RAGraph data structure for function StreamCluster6LCacc
inline void Wait_sig__StreamCluster6LCacc(InstanceData_sig__StreamCluster6LCacc* instance)
{
	while(1)
	{
		...
		InterruptArgs* args = 0;
		void (*progress)(InstanceData_sig__StreamCluster6LCacc*);
		while((args = LWI_CheckInterrupt(thread)) == 0);
		switch(args->lcaccMode)
		{
			case(0):
				progress = GAMHandler_sig__StreamCluster6LCacc(instance, args);
				break;
			case(LCACC_CLASS_SIG__StreamCluster6LCacc__x):
				progress = ProgressHandler_sig__StreamCluster6LCacc__x(instance, args);
				break;
			default:
				ErrorHandler_sig__StreamCluster6LCacc(instance);
				simics_assert(0);
		}
	...
	switch(args->status)
	{
		case(LCACC_GAM_WAIT):
			...
			if(instance->reservedAccelerators == 1)
			{
				...
				LCAcc_Reserve(args->threadID, 0, DelayEstimate_sig__StreamCluster6LCacc(instance->acceleratorVectorLength));
			}
			return 0;
			break;
		case(LCACC_GAM_GRANT):
			...
			{
				case(1206):
					if(instance->allocatedAcceleratorCount__streamCluster6 == 1)
					{
						return ErrorHandler_sig__StreamCluster6LCacc;
					}
					else
					{
						instance->pendingAccelerators++;
						instance->allocatedAcceleratorIDSet__streamCluster6[instance->allocatedAcceleratorCount__streamCluster6] = lcaccID;
						instance->allocatedAcceleratorCount__streamCluster6++;
					}
					break;
				default:
					return ErrorHandler_sig__StreamCluster6LCacc;
			...
			if(instance->allocatedAcceleratorCount__streamCluster6 == 1)
			{
				return StartEverythingHandler_sig__StreamCluster6LCacc;
			}
			else
			{
				return 0;
...
inline void Cleanup_sig__StreamCluster6LCacc(InstanceData_sig__StreamCluster6LCacc* instance)
{
	...
	if(instance->allocatedAcceleratorIDSet__streamCluster6[0] != 0)
	{
...
inline void StopEverythingHandler_sig__StreamCluster6LCacc(InstanceData_sig__StreamCluster6LCacc* instance)
{
	Cleanup_sig__StreamCluster6LCacc(instance);
}
inline void ErrorHandler_sig__StreamCluster6LCacc(InstanceData_sig__StreamCluster6LCacc* instance)
{
	Cleanup_sig__StreamCluster6LCacc(instance);
...
inline void (*ProgressHandler_sig__StreamCluster6LCacc__x(InstanceData_sig__StreamCluster6LCacc* instance, InterruptArgs* args))(InstanceData_sig__StreamCluster6LCacc*)
{
	switch(args->status)
	{
		...
		case(LCACC_STATUS_COMPLETED):
			...
			{
				return StopEverythingHandler_sig__StreamCluster6LCacc;
			}
			else
			{
				return 0;
...
inline void StartEverythingHandler_sig__StreamCluster6LCacc(InstanceData_sig__StreamCluster6LCacc* instance)
{
	...
	instance->HandlerArgs__x.lcaccID = instance->allocatedAcceleratorIDSet__streamCluster6[0];
	...
	instance->HandlerArgs__x.lcaccMode = LCACC_CLASS_SIG__StreamCluster6LCacc__x;
	...
	Wait_sig__StreamCluster6LCacc(instance);// wait for everything to finish
}
inline void CreateBuffer_StreamCluster6LCacc_sig(int thread, InstanceData_sig__StreamCluster6LCacc* instance, uint32_t (*inIsCenter), uint32_t (*table), uint32_t (*outIsCenter), uint64_t lower, int size, int chunk)
{
	int index, i;
	...
	instance->node_x.SetSPMConfig((sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)), 3, 0);
	instance->LCAcc_FuncArgs__inIsCenter = inIsCenter;
	instance->LCAcc_FuncArgs__table = table;
	instance->LCAcc_FuncArgs__outIsCenter = outIsCenter;
	instance->LCAcc_FuncVars__lower = lower;
	instance->LCAcc_FuncVars__size = size;
	instance->LCAcc_FuncVars__chunk = chunk;
	instance->allocatedAcceleratorCount__streamCluster6 = 0;
	LCAccNode& VNR_vardecl_0(instance->node_x);
	void* VNR_vardecl_1(instance->LCAcc_FuncArgs__inIsCenter);
	void* VNR_vardecl_2(instance->LCAcc_FuncArgs__table);
	void* VNR_vardecl_3(instance->LCAcc_FuncArgs__outIsCenter);
	...
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_6(((sizeof(uint32_t) * (chunk))) + ((((0) * (sizeof(uint32_t))))), sizeof(uint32_t), VNR_vardecl_4, VNR_vardecl_5);
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_7(((sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk))) + ((((0) * (sizeof(uint32_t))))), sizeof(uint32_t), VNR_vardecl_4, VNR_vardecl_5);
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_8((0) + ((((0) * (sizeof(uint32_t))))), sizeof(uint32_t), VNR_vardecl_4, VNR_vardecl_5);
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_9(((sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk))) + ((((0) * (sizeof(uint32_t))))), sizeof(uint32_t), VNR_vardecl_4, VNR_vardecl_5);
	...
	VNR_vardecl_11.push_back(ConvertToType<uint64_t, uint64_t>(lower)/*Register lowerAddr*/);
	VNR_vardecl_11.push_back(ConvertToType<uint64_t, uint64_t>((0))/*Register spmTarget*/);
	...
	instance->acceleratorSignature__x.AddTransfer(VNR_vardecl_1, VNR_vardecl_12, VNR_vardecl_13, VNR_vardecl_4, VNR_vardecl_14, VNR_vardecl_0, ((sizeof(uint32_t) * (chunk))) + ((((0) * ((sizeof(uint32_t)))))), VNR_vardecl_4, VNR_vardecl_14, sizeof(uint32_t));
	//transfer from table to x
	//Search VNR_vardecl_12 for source block size.
	//Search VNR_vardecl_13 for source block stride.
	//Search VNR_vardecl_4 for source element size.
	//Search VNR_vardecl_14 for source element stride.
	//Search VNR_vardecl_4 for destination size.
	//Search VNR_vardecl_14 for destination stride.
	instance->acceleratorSignature__x.AddTransfer(VNR_vardecl_2, VNR_vardecl_12, VNR_vardecl_13, VNR_vardecl_4, VNR_vardecl_14, VNR_vardecl_0, ((sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk))) + ((((0) * ((sizeof(uint32_t)))))), VNR_vardecl_4, VNR_vardecl_14, sizeof(uint32_t));
	//transfer from x to outIsCenter
	...
	//Search VNR_vardecl_13 for destination block stride.
	//Search VNR_vardecl_4 for destination element size.
	//Search VNR_vardecl_14 for destination element stride.
	instance->acceleratorSignature__x.AddTransfer(VNR_vardecl_0, ((sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk))) + ((((0) * ((sizeof(uint32_t)))))), VNR_vardecl_4, VNR_vardecl_14, VNR_vardecl_3, VNR_vardecl_12, VNR_vardecl_13, VNR_vardecl_4, VNR_vardecl_14, sizeof(uint32_t));
	instance->acceleratorSignature__x.Finalize((((size) - (0)) / (chunk)));
}
inline void StreamCluster6LCacc_sig_buf(int threadID, InstanceData_sig__StreamCluster6LCacc* instance)
{
	instance->Reset();
	LWI_RegisterInterruptHandler(&(instance->GAM_INTERACTION));
	LCAcc_Request(threadID, 1206, 1);//request something of type AcceleratorType
	Wait_sig__StreamCluster6LCacc(instance);// wait for everything to finish
}
inline void StreamCluster6LCacc_sig(int threadID, uint32_t (*inIsCenter), uint32_t (*table), uint32_t (*outIsCenter), uint64_t lower, int size, int chunk)
{
	InstanceData_sig__StreamCluster6LCacc instance;
	CreateBuffer_StreamCluster6LCacc_sig(threadID, &instance, inIsCenter, table, outIsCenter, lower, size, chunk);
	StreamCluster6LCacc_sig_buf(threadID, &instance);
}
class BiN_StreamCluster6LCacc_Arbitrator_sig
{
	std::vector<InstanceData_sig__StreamCluster6LCacc*> instanceSet;
	...
	InterruptArgs isr;
public:
	inline BiN_StreamCluster6LCacc_Arbitrator_sig(int thread)
	{
		ops.push_back(1206);
		count.push_back(1);
		threadID = thread;
	}
	inline void AddConfig(InstanceData_sig__StreamCluster6LCacc* inst, uint32_t performance, uint32_t cacheMod)
	{
	...
	inline void Run()
	{
		...
		int allocatedAcceleratorCount__streamCluster6 = 0;
		LCAcc_Request(threadID, 1206, 1);//request something of type AcceleratorType
		bool cont = true;
				...
				case(LCACC_GAM_GRANT):
					{
						...
						{
							case(1206):
								simics_assert(allocatedAcceleratorCount__streamCluster6 < 1);
								allocatedAcceleratorIDSet__streamCluster6[allocatedAcceleratorCount__streamCluster6] = lcaccID;
								allocatedAcceleratorCount__streamCluster6++;
								break;
							default:
								simics_assert(0);
						}
						if(allocatedAcceleratorCount__streamCluster6 == 1)
						{
							cont = false;
						}
					}
		...
		InstanceData_sig__StreamCluster6LCacc* inst = NULL;
		for(size_t i = 0; i < instanceSet.size(); i++)
		{
		...
		for(int i = 0; i < 1; i++)
		{
			inst->allocatedAcceleratorIDSet__streamCluster6[i] = allocatedAcceleratorIDSet__streamCluster6[i];
		}
		inst->allocatedAcceleratorCount__streamCluster6 = allocatedAcceleratorCount__streamCluster6;
		inst->pendingAccelerators = 1;
		StartEverythingHandler_sig__StreamCluster6LCacc(inst);
	}
};

#endif
#ifndef LCACC_BODY_TD__StreamCluster6LCacc__X
#define LCACC_BODY_TD__StreamCluster6LCacc__X

inline void Wait_td__StreamCluster6LCacc(int thread)
{
...
inline void CreateBuffer_StreamCluster6LCacc_td(uint8_t** buffer, uint32_t* bufferSize, uint8_t** constCluster, int thread, uint32_t (*inIsCenter), uint32_t (*table), uint32_t (*outIsCenter), uint64_t lower, int size, int chunk)
{
	MicroprogramWriter mw(false);
	void* LCAcc_FuncArgs__inIsCenter = inIsCenter;
	void* LCAcc_FuncArgs__table = table;
	void* LCAcc_FuncArgs__outIsCenter = outIsCenter;
	{
		void* VNR_vardecl_0(inIsCenter);
		void* VNR_vardecl_1(table);
		void* VNR_vardecl_2(outIsCenter);
		LCAccNode VNR_vardecl_3(1206, (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)), 2, 0, 0);
		std::vector<uint32_t> VNR_vardecl_4;
		VNR_vardecl_4.push_back(((chunk) - (0)) / (1));
		std::vector<int32_t> VNR_vardecl_5;
		VNR_vardecl_5.push_back((1) * (sizeof(uint32_t)));
		...
		//Search VNR_vardecl_4 for destination size.
		//Search VNR_vardecl_14 for destination stride.
		mw.AddTransfer(VNR_vardecl_0, VNR_vardecl_12, VNR_vardecl_13, VNR_vardecl_4, VNR_vardecl_14, VNR_vardecl_3, ((sizeof(uint32_t) * (chunk))) + ((((0) * ((sizeof(uint32_t)))))), VNR_vardecl_4, VNR_vardecl_14, sizeof(uint32_t));
		...
		//Search VNR_vardecl_4 for destination size.
		//Search VNR_vardecl_14 for destination stride.
		mw.AddTransfer(VNR_vardecl_1, VNR_vardecl_12, VNR_vardecl_13, VNR_vardecl_4, VNR_vardecl_14, VNR_vardecl_3, ((sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk))) + ((((0) * ((sizeof(uint32_t)))))), VNR_vardecl_4, VNR_vardecl_14, sizeof(uint32_t));
		...
		//Search VNR_vardecl_4 for destination element size.
		//Search VNR_vardecl_14 for destination element stride.
		mw.AddTransfer(VNR_vardecl_3, ((sizeof(uint32_t) * (chunk)) + (sizeof(uint32_t) * (chunk))) + ((((0) * ((sizeof(uint32_t)))))), VNR_vardecl_4, VNR_vardecl_14, VNR_vardecl_2, VNR_vardecl_12, VNR_vardecl_13, VNR_vardecl_4, VNR_vardecl_14, sizeof(uint32_t));
...
inline void StreamCluster6LCacc_td_buf(uint8_t* buf, uint32_t bufSize, int thread)
{
	...
	Wait_td__StreamCluster6LCacc(thread);// wait for everything to finish
}
void StreamCluster6LCacc_td(int thread, uint32_t (*inIsCenter), uint32_t (*table), uint32_t (*outIsCenter), uint64_t lower, int size, int chunk)
{
	uint32_t bufSize;
	uint8_t* buffer;
	uint8_t* constCluster = NULL;
	CreateBuffer_StreamCluster6LCacc_td(&buffer, &bufSize, &constCluster, thread, inIsCenter, table, outIsCenter, lower, size, chunk);
	StreamCluster6LCacc_td_buf(buffer, bufSize, thread);
	if(constCluster)
	{
		delete [] constCluster;
	}
...
inline uint32_t StreamCluster6LCacc_CalculateBiNSize(uint64_t lower, int size, int chunk)
{
	return 0;
}
class BiN_StreamCluster6LCacc_Arbitrator_td
{
	...
	InterruptArgs isr;
public:
	inline BiN_StreamCluster6LCacc_Arbitrator_td(){}
	...
	inline void Run(int threadID)
	{
		...
		isr.lcaccID = 0;
		isr.lcaccMode = 0;
		LCAcc_DeclareLCAccUse(threadID, 1206, 1); //requests for streamCluster6
		...
		for(size_t i = 0; i < binSizeSet.size(); i++)
		{
			...
			{
				StreamCluster6LCacc_td_buf(bufSet[i], bufSizeSet[i], threadID);
				return;
			}
		}
		simics_assert(0);
