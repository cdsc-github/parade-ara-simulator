...
#endif
#ifndef LCACC_BODY_SIG__Swaptions1LCacc__X
#define LCACC_BODY_SIG__Swaptions1LCacc__X
#define LCACC_CLASS_SIG__Swaptions1LCacc__x 1
class InstanceData_sig__Swaptions1LCacc
{
public:
	...
	int allocatedAcceleratorCount__swaptions1;
	int allocatedAcceleratorIDSet__swaptions1[1];
	float (*LCAcc_FuncArgs__seed);
	float (*LCAcc_FuncArgs__result)[3][11];
	...
	inline void Reset()
	{
		...
		allocatedAcceleratorCount__swaptions1 = 0;
		reservedAccelerators = 0;
		allocatedAcceleratorIDSet__swaptions1[0] = 0;
		HandlerArgs__x.threadID = threadID;
		HandlerArgs__x.status = 0;
		HandlerArgs__x.taskIndex = 0;
		HandlerArgs__x.lcaccMode = LCACC_CLASS_SIG__Swaptions1LCacc__x;
		node_x.Reset();
	}
...
inline void Cleanup_sig__Swaptions1LCacc(InstanceData_sig__Swaptions1LCacc* instance);
inline void StartEverythingHandler_sig__Swaptions1LCacc(InstanceData_sig__Swaptions1LCacc* instance);
inline void StopEverythingHandler_sig__Swaptions1LCacc(InstanceData_sig__Swaptions1LCacc* instance);
inline void ErrorHandler_sig__Swaptions1LCacc(InstanceData_sig__Swaptions1LCacc* instance);
inline void Wait_sig__Swaptions1LCacc(InstanceData_sig__Swaptions1LCacc* instance);
inline unsigned int DelayEstimate_sig__Swaptions1LCacc(int vectorSize)
{
	return 1;
}
inline void (*ProgressHandler_sig__Swaptions1LCacc__x(InstanceData_sig__Swaptions1LCacc* instance, InterruptArgs* args))(InstanceData_sig__Swaptions1LCacc*);
//This is a procedurally generated interrupt-based program from a RAGraph data structure for function Swaptions1LCacc
inline void Wait_sig__Swaptions1LCacc(InstanceData_sig__Swaptions1LCacc* instance)
{
	while(1)
	{
		...
		InterruptArgs* args = 0;
		void (*progress)(InstanceData_sig__Swaptions1LCacc*);
		while((args = LWI_CheckInterrupt(thread)) == 0);
		switch(args->lcaccMode)
		{
			case(0):
				progress = GAMHandler_sig__Swaptions1LCacc(instance, args);
				break;
			case(LCACC_CLASS_SIG__Swaptions1LCacc__x):
				progress = ProgressHandler_sig__Swaptions1LCacc__x(instance, args);
				break;
			default:
				ErrorHandler_sig__Swaptions1LCacc(instance);
				simics_assert(0);
		}
	...
	switch(args->status)
	{
		case(LCACC_GAM_WAIT):
			...
			if(instance->reservedAccelerators == 1)
			{
				...
				LCAcc_Reserve(args->threadID, 0, DelayEstimate_sig__Swaptions1LCacc(instance->acceleratorVectorLength));
			}
			return 0;
			break;
		case(LCACC_GAM_GRANT):
			...
			{
				case(1301):
					if(instance->allocatedAcceleratorCount__swaptions1 == 1)
					{
						return ErrorHandler_sig__Swaptions1LCacc;
					}
					else
					{
						instance->pendingAccelerators++;
						instance->allocatedAcceleratorIDSet__swaptions1[instance->allocatedAcceleratorCount__swaptions1] = lcaccID;
						instance->allocatedAcceleratorCount__swaptions1++;
					}
					break;
				default:
					return ErrorHandler_sig__Swaptions1LCacc;
			...
			if(instance->allocatedAcceleratorCount__swaptions1 == 1)
			{
				return StartEverythingHandler_sig__Swaptions1LCacc;
			}
			else
			{
				return 0;
...
inline void Cleanup_sig__Swaptions1LCacc(InstanceData_sig__Swaptions1LCacc* instance)
{
	...
	if(instance->allocatedAcceleratorIDSet__swaptions1[0] != 0)
	{
...
inline void StopEverythingHandler_sig__Swaptions1LCacc(InstanceData_sig__Swaptions1LCacc* instance)
{
	Cleanup_sig__Swaptions1LCacc(instance);
}
inline void ErrorHandler_sig__Swaptions1LCacc(InstanceData_sig__Swaptions1LCacc* instance)
{
	Cleanup_sig__Swaptions1LCacc(instance);
...
inline void (*ProgressHandler_sig__Swaptions1LCacc__x(InstanceData_sig__Swaptions1LCacc* instance, InterruptArgs* args))(InstanceData_sig__Swaptions1LCacc*)
{
	switch(args->status)
	{
		...
		case(LCACC_STATUS_COMPLETED):
			...
			{
				return StopEverythingHandler_sig__Swaptions1LCacc;
			}
			else
			{
				return 0;
...
inline void StartEverythingHandler_sig__Swaptions1LCacc(InstanceData_sig__Swaptions1LCacc* instance)
{
	...
	instance->HandlerArgs__x.lcaccID = instance->allocatedAcceleratorIDSet__swaptions1[0];
	...
	instance->HandlerArgs__x.lcaccMode = LCACC_CLASS_SIG__Swaptions1LCacc__x;
	...
	Wait_sig__Swaptions1LCacc(instance);// wait for everything to finish
}
inline void CreateBuffer_Swaptions1LCacc_sig(int thread, InstanceData_sig__Swaptions1LCacc* instance, float (*seed), float (*result)[3][11], int size, int chunk)
{
	int index, i;
	...
	instance->node_x.SetSPMConfig((sizeof(float) * (chunk)) + (sizeof(float[3][11]) * (chunk)), 3, 0);
	instance->LCAcc_FuncArgs__seed = seed;
	instance->LCAcc_FuncArgs__result = result;
	instance->LCAcc_FuncVars__size = size;
	instance->LCAcc_FuncVars__chunk = chunk;
	instance->allocatedAcceleratorCount__swaptions1 = 0;
	LCAccNode& VNR_vardecl_0(instance->node_x);
	void* VNR_vardecl_1(instance->LCAcc_FuncArgs__seed);
	void* VNR_vardecl_2(instance->LCAcc_FuncArgs__result);
	...
	VNR_vardecl_6.push_back((1) * (sizeof(float[3][11])));
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_7(((sizeof(float) * (chunk))) + ((((0) * (sizeof(float[3][11]))))), sizeof(float), VNR_vardecl_3, VNR_vardecl_6);
	...
	VNR_vardecl_10.push_back(((size) - (0)) / (chunk));
	std::vector<int32_t> VNR_vardecl_11;
	VNR_vardecl_11.push_back((chunk) * ((sizeof(float))));
	std::vector<int32_t> VNR_vardecl_12;
	VNR_vardecl_12.push_back((1) * ((sizeof(float))));
	std::vector<uint32_t> VNR_vardecl_13;
	VNR_vardecl_13.push_back(((chunk) - (0)) / (1));
	VNR_vardecl_13.push_back((33));
	std::vector<int32_t> VNR_vardecl_14;
	VNR_vardecl_14.push_back((1) * ((sizeof(float[3][11]))));
	VNR_vardecl_14.push_back((sizeof(float)));
	std::vector<int32_t> VNR_vardecl_15;
	VNR_vardecl_15.push_back((chunk) * ((sizeof(float[3][11]))));
	//produce compute set
	//See VNR_vardecl_8 for index variable decl
	//See VNR_vardecl_9 for register set decl
	instance->acceleratorSignature__x.AddCompute(VNR_vardecl_0, VNR_vardecl_8, VNR_vardecl_9);
	...
	//Search VNR_vardecl_12 for source element stride.
	//Search VNR_vardecl_3 for destination size.
	//Search VNR_vardecl_12 for destination stride.
	instance->acceleratorSignature__x.AddTransfer(VNR_vardecl_1, VNR_vardecl_10, VNR_vardecl_11, VNR_vardecl_3, VNR_vardecl_12, VNR_vardecl_0, (0) + ((((0) * ((sizeof(float)))))), VNR_vardecl_3, VNR_vardecl_12, sizeof(float));
	...
	instance->acceleratorSignature__x.AddTransfer(VNR_vardecl_0, ((sizeof(float) * (chunk))) + ((((0) * ((sizeof(float[3][11])))))), VNR_vardecl_13, VNR_vardecl_14, VNR_vardecl_2, VNR_vardecl_10, VNR_vardecl_15, VNR_vardecl_13, VNR_vardecl_14, sizeof(float));
	instance->acceleratorSignature__x.Finalize((((size) - (0)) / (chunk)));
}
inline void Swaptions1LCacc_sig_buf(int threadID, InstanceData_sig__Swaptions1LCacc* instance)
{
	instance->Reset();
	LWI_RegisterInterruptHandler(&(instance->GAM_INTERACTION));
	LCAcc_Request(threadID, 1301, 1);//request something of type AcceleratorType
	Wait_sig__Swaptions1LCacc(instance);// wait for everything to finish
}
inline void Swaptions1LCacc_sig(int threadID, float (*seed), float (*result)[3][11], int size, int chunk)
{
	InstanceData_sig__Swaptions1LCacc instance;
	CreateBuffer_Swaptions1LCacc_sig(threadID, &instance, seed, result, size, chunk);
	Swaptions1LCacc_sig_buf(threadID, &instance);
}
class BiN_Swaptions1LCacc_Arbitrator_sig
{
	std::vector<InstanceData_sig__Swaptions1LCacc*> instanceSet;
	...
	InterruptArgs isr;
public:
	inline BiN_Swaptions1LCacc_Arbitrator_sig(int thread)
	{
		ops.push_back(1301);
		count.push_back(1);
		threadID = thread;
	}
	inline void AddConfig(InstanceData_sig__Swaptions1LCacc* inst, uint32_t performance, uint32_t cacheMod)
	{
	...
	inline void Run()
	{
		...
		int allocatedAcceleratorCount__swaptions1 = 0;
		LCAcc_Request(threadID, 1301, 1);//request something of type AcceleratorType
		bool cont = true;
				...
				case(LCACC_GAM_GRANT):
					{
						...
						{
							case(1301):
								simics_assert(allocatedAcceleratorCount__swaptions1 < 1);
								allocatedAcceleratorIDSet__swaptions1[allocatedAcceleratorCount__swaptions1] = lcaccID;
								allocatedAcceleratorCount__swaptions1++;
								break;
							default:
								simics_assert(0);
						}
						if(allocatedAcceleratorCount__swaptions1 == 1)
						{
							cont = false;
						}
					}
		...
		InstanceData_sig__Swaptions1LCacc* inst = NULL;
		for(size_t i = 0; i < instanceSet.size(); i++)
		{
		...
		for(int i = 0; i < 1; i++)
		{
			inst->allocatedAcceleratorIDSet__swaptions1[i] = allocatedAcceleratorIDSet__swaptions1[i];
		}
		inst->allocatedAcceleratorCount__swaptions1 = allocatedAcceleratorCount__swaptions1;
		inst->pendingAccelerators = 1;
		StartEverythingHandler_sig__Swaptions1LCacc(inst);
	}
};

#endif
#ifndef LCACC_BODY_TD__Swaptions1LCacc__X
#define LCACC_BODY_TD__Swaptions1LCacc__X

inline void Wait_td__Swaptions1LCacc(int thread)
{
...
inline void CreateBuffer_Swaptions1LCacc_td(uint8_t** buffer, uint32_t* bufferSize, uint8_t** constCluster, int thread, float (*seed), float (*result)[3][11], int size, int chunk)
{
	MicroprogramWriter mw(false);
	void* LCAcc_FuncArgs__seed = seed;
...
inline void Swaptions1LCacc_td_buf(uint8_t* buf, uint32_t bufSize, int thread)
{
	...
	Wait_td__Swaptions1LCacc(thread);// wait for everything to finish
}
void Swaptions1LCacc_td(int thread, float (*seed), float (*result)[3][11], int size, int chunk)
{
	uint32_t bufSize;
	uint8_t* buffer;
	uint8_t* constCluster = NULL;
	CreateBuffer_Swaptions1LCacc_td(&buffer, &bufSize, &constCluster, thread, seed, result, size, chunk);
	Swaptions1LCacc_td_buf(buffer, bufSize, thread);
	if(constCluster)
	{
		delete [] constCluster;
	}
...
inline uint32_t Swaptions1LCacc_CalculateBiNSize(int size, int chunk)
{
	return 0;
}
class BiN_Swaptions1LCacc_Arbitrator_td
{
	...
	InterruptArgs isr;
public:
	inline BiN_Swaptions1LCacc_Arbitrator_td(){}
	...
	inline void Run(int threadID)
	{
		...
		isr.lcaccID = 0;
		isr.lcaccMode = 0;
		LCAcc_DeclareLCAccUse(threadID, 1301, 1); //requests for swaptions1
		...
		for(size_t i = 0; i < binSizeSet.size(); i++)
		{
			...
			{
				Swaptions1LCacc_td_buf(bufSet[i], bufSizeSet[i], threadID);
				return;
			}
		}
		simics_assert(0);
