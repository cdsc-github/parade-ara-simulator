...
#endif
#ifndef LCACC_BODY_SIG__Swaptions3LCacc__X
#define LCACC_BODY_SIG__Swaptions3LCacc__X
#define LCACC_CLASS_SIG__Swaptions3LCacc__x 1
class InstanceData_sig__Swaptions3LCacc
{
public:
	...
	int allocatedAcceleratorCount__swaptions3;
	int allocatedAcceleratorIDSet__swaptions3[1];
	float (*LCAcc_FuncArgs__ppdFactors)[3][11];
	float (*LCAcc_FuncArgs__pdZ)[3][11];
	...
	inline void Reset()
	{
		...
		allocatedAcceleratorCount__swaptions3 = 0;
		reservedAccelerators = 0;
		allocatedAcceleratorIDSet__swaptions3[0] = 0;
		HandlerArgs__x.threadID = threadID;
		HandlerArgs__x.status = 0;
		HandlerArgs__x.taskIndex = 0;
		HandlerArgs__x.lcaccMode = LCACC_CLASS_SIG__Swaptions3LCacc__x;
		node_x.Reset();
	}
...
inline void Cleanup_sig__Swaptions3LCacc(InstanceData_sig__Swaptions3LCacc* instance);
inline void StartEverythingHandler_sig__Swaptions3LCacc(InstanceData_sig__Swaptions3LCacc* instance);
inline void StopEverythingHandler_sig__Swaptions3LCacc(InstanceData_sig__Swaptions3LCacc* instance);
inline void ErrorHandler_sig__Swaptions3LCacc(InstanceData_sig__Swaptions3LCacc* instance);
inline void Wait_sig__Swaptions3LCacc(InstanceData_sig__Swaptions3LCacc* instance);
inline unsigned int DelayEstimate_sig__Swaptions3LCacc(int vectorSize)
{
	return 1;
}
inline void (*ProgressHandler_sig__Swaptions3LCacc__x(InstanceData_sig__Swaptions3LCacc* instance, InterruptArgs* args))(InstanceData_sig__Swaptions3LCacc*);
//This is a procedurally generated interrupt-based program from a RAGraph data structure for function Swaptions3LCacc
inline void Wait_sig__Swaptions3LCacc(InstanceData_sig__Swaptions3LCacc* instance)
{
	while(1)
	{
		...
		InterruptArgs* args = 0;
		void (*progress)(InstanceData_sig__Swaptions3LCacc*);
		while((args = LWI_CheckInterrupt(thread)) == 0);
		switch(args->lcaccMode)
		{
			case(0):
				progress = GAMHandler_sig__Swaptions3LCacc(instance, args);
				break;
			case(LCACC_CLASS_SIG__Swaptions3LCacc__x):
				progress = ProgressHandler_sig__Swaptions3LCacc__x(instance, args);
				break;
			default:
				ErrorHandler_sig__Swaptions3LCacc(instance);
				simics_assert(0);
		}
	...
	switch(args->status)
	{
		case(LCACC_GAM_WAIT):
			...
			if(instance->reservedAccelerators == 1)
			{
				...
				LCAcc_Reserve(args->threadID, 0, DelayEstimate_sig__Swaptions3LCacc(instance->acceleratorVectorLength));
			}
			return 0;
			break;
		case(LCACC_GAM_GRANT):
			...
			{
				case(1303):
					if(instance->allocatedAcceleratorCount__swaptions3 == 1)
					{
						return ErrorHandler_sig__Swaptions3LCacc;
					}
					else
					{
						instance->pendingAccelerators++;
						instance->allocatedAcceleratorIDSet__swaptions3[instance->allocatedAcceleratorCount__swaptions3] = lcaccID;
						instance->allocatedAcceleratorCount__swaptions3++;
					}
					break;
				default:
					return ErrorHandler_sig__Swaptions3LCacc;
			...
			if(instance->allocatedAcceleratorCount__swaptions3 == 1)
			{
				return StartEverythingHandler_sig__Swaptions3LCacc;
			}
			else
			{
				return 0;
...
inline void Cleanup_sig__Swaptions3LCacc(InstanceData_sig__Swaptions3LCacc* instance)
{
	...
	if(instance->allocatedAcceleratorIDSet__swaptions3[0] != 0)
	{
...
inline void StopEverythingHandler_sig__Swaptions3LCacc(InstanceData_sig__Swaptions3LCacc* instance)
{
	Cleanup_sig__Swaptions3LCacc(instance);
}
inline void ErrorHandler_sig__Swaptions3LCacc(InstanceData_sig__Swaptions3LCacc* instance)
{
	Cleanup_sig__Swaptions3LCacc(instance);
...
inline void (*ProgressHandler_sig__Swaptions3LCacc__x(InstanceData_sig__Swaptions3LCacc* instance, InterruptArgs* args))(InstanceData_sig__Swaptions3LCacc*)
{
	switch(args->status)
	{
		...
		case(LCACC_STATUS_COMPLETED):
			...
			{
				return StopEverythingHandler_sig__Swaptions3LCacc;
			}
			else
			{
				return 0;
...
inline void StartEverythingHandler_sig__Swaptions3LCacc(InstanceData_sig__Swaptions3LCacc* instance)
{
	...
	instance->HandlerArgs__x.lcaccID = instance->allocatedAcceleratorIDSet__swaptions3[0];
	...
	instance->HandlerArgs__x.lcaccMode = LCACC_CLASS_SIG__Swaptions3LCacc__x;
	...
	Wait_sig__Swaptions3LCacc(instance);// wait for everything to finish
}
inline void CreateBuffer_Swaptions3LCacc_sig(int thread, InstanceData_sig__Swaptions3LCacc* instance, float (*ppdFactors)[3][11], float (*pdZ)[3][11], float (*shockVals)[55], int size, int chunk)
{
	int index, i;
	...
	instance->node_x.SetSPMConfig((sizeof(float[3][11]) * (chunk)) + (sizeof(float[3][11]) * (chunk)) + (sizeof(float[55]) * (chunk)), 3, 0);
	instance->LCAcc_FuncArgs__ppdFactors = ppdFactors;
	...
	instance->allocatedAcceleratorCount__swaptions3 = 0;
	LCAccNode& VNR_vardecl_0(instance->node_x);
	void* VNR_vardecl_1(instance->LCAcc_FuncArgs__ppdFactors);
	void* VNR_vardecl_2(instance->LCAcc_FuncArgs__pdZ);
	void* VNR_vardecl_3(instance->LCAcc_FuncArgs__shockVals);
	std::vector<uint32_t> VNR_vardecl_4;
	VNR_vardecl_4.push_back(((chunk) - (0)) / (1));
	std::vector<int32_t> VNR_vardecl_5;
	VNR_vardecl_5.push_back((1) * (sizeof(float[3][11])));
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_6((0) + ((((0) * (sizeof(float[3][11]))))), sizeof(float), VNR_vardecl_4, VNR_vardecl_5);
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_7(((sizeof(float[3][11]) * (chunk))) + ((((0) * (sizeof(float[3][11]))))), sizeof(float), VNR_vardecl_4, VNR_vardecl_5);
	std::vector<int32_t> VNR_vardecl_8;
	VNR_vardecl_8.push_back((1) * (sizeof(float[55])));
	MicroprogramWriter::ComputeArgIndex VNR_vardecl_9(((sizeof(float[3][11]) * (chunk)) + (sizeof(float[3][11]) * (chunk))) + ((((0) * (sizeof(float[55]))))), sizeof(float), VNR_vardecl_4, VNR_vardecl_8);
	...
	VNR_vardecl_13.push_back((chunk) * ((sizeof(float[3][11]))));
	std::vector<uint32_t> VNR_vardecl_14;
	VNR_vardecl_14.push_back(((chunk) - (0)) / (1));
	VNR_vardecl_14.push_back((33));
	std::vector<int32_t> VNR_vardecl_15;
	VNR_vardecl_15.push_back((1) * ((sizeof(float[3][11]))));
	VNR_vardecl_15.push_back((sizeof(float)));
	std::vector<uint32_t> VNR_vardecl_16;
	VNR_vardecl_16.push_back(((chunk) - (0)) / (1));
	VNR_vardecl_16.push_back((55));
	std::vector<int32_t> VNR_vardecl_17;
	VNR_vardecl_17.push_back((1) * ((sizeof(float[55]))));
	VNR_vardecl_17.push_back((sizeof(float)));
	std::vector<int32_t> VNR_vardecl_18;
	VNR_vardecl_18.push_back((chunk) * ((sizeof(float[55]))));
	//produce compute set
	...
	//Search VNR_vardecl_14 for source element size.
	...
	instance->acceleratorSignature__x.AddTransfer(VNR_vardecl_1, VNR_vardecl_12, VNR_vardecl_13, VNR_vardecl_14, VNR_vardecl_15, VNR_vardecl_0, (0) + ((((0) * ((sizeof(float[3][11])))))), VNR_vardecl_14, VNR_vardecl_15, sizeof(float));
	...
	//Search VNR_vardecl_14 for destination size.
	//Search VNR_vardecl_15 for destination stride.
	instance->acceleratorSignature__x.AddTransfer(VNR_vardecl_2, VNR_vardecl_12, VNR_vardecl_13, VNR_vardecl_14, VNR_vardecl_15, VNR_vardecl_0, ((sizeof(float[3][11]) * (chunk))) + ((((0) * ((sizeof(float[3][11])))))), VNR_vardecl_14, VNR_vardecl_15, sizeof(float));
	...
	//Search VNR_vardecl_18 for destination block stride.
	//Search VNR_vardecl_16 for destination element size.
	//Search VNR_vardecl_17 for destination element stride.
	instance->acceleratorSignature__x.AddTransfer(VNR_vardecl_0, ((sizeof(float[3][11]) * (chunk)) + (sizeof(float[3][11]) * (chunk))) + ((((0) * ((sizeof(float[55])))))), VNR_vardecl_16, VNR_vardecl_17, VNR_vardecl_3, VNR_vardecl_12, VNR_vardecl_18, VNR_vardecl_16, VNR_vardecl_17, sizeof(float));
	instance->acceleratorSignature__x.Finalize((((size) - (0)) / (chunk)));
}
inline void Swaptions3LCacc_sig_buf(int threadID, InstanceData_sig__Swaptions3LCacc* instance)
{
	instance->Reset();
	LWI_RegisterInterruptHandler(&(instance->GAM_INTERACTION));
	LCAcc_Request(threadID, 1303, 1);//request something of type AcceleratorType
	Wait_sig__Swaptions3LCacc(instance);// wait for everything to finish
}
inline void Swaptions3LCacc_sig(int threadID, float (*ppdFactors)[3][11], float (*pdZ)[3][11], float (*shockVals)[55], int size, int chunk)
{
	InstanceData_sig__Swaptions3LCacc instance;
	CreateBuffer_Swaptions3LCacc_sig(threadID, &instance, ppdFactors, pdZ, shockVals, size, chunk);
	Swaptions3LCacc_sig_buf(threadID, &instance);
}
class BiN_Swaptions3LCacc_Arbitrator_sig
{
	std::vector<InstanceData_sig__Swaptions3LCacc*> instanceSet;
	...
	InterruptArgs isr;
public:
	inline BiN_Swaptions3LCacc_Arbitrator_sig(int thread)
	{
		ops.push_back(1303);
		count.push_back(1);
		threadID = thread;
	}
	inline void AddConfig(InstanceData_sig__Swaptions3LCacc* inst, uint32_t performance, uint32_t cacheMod)
	{
	...
	inline void Run()
	{
		...
		int allocatedAcceleratorCount__swaptions3 = 0;
		LCAcc_Request(threadID, 1303, 1);//request something of type AcceleratorType
		bool cont = true;
				...
				case(LCACC_GAM_GRANT):
					{
						...
						{
							case(1303):
								simics_assert(allocatedAcceleratorCount__swaptions3 < 1);
								allocatedAcceleratorIDSet__swaptions3[allocatedAcceleratorCount__swaptions3] = lcaccID;
								allocatedAcceleratorCount__swaptions3++;
								break;
							default:
								simics_assert(0);
						}
						if(allocatedAcceleratorCount__swaptions3 == 1)
						{
							cont = false;
						}
					}
		...
		InstanceData_sig__Swaptions3LCacc* inst = NULL;
		for(size_t i = 0; i < instanceSet.size(); i++)
		{
		...
		for(int i = 0; i < 1; i++)
		{
			inst->allocatedAcceleratorIDSet__swaptions3[i] = allocatedAcceleratorIDSet__swaptions3[i];
		}
		inst->allocatedAcceleratorCount__swaptions3 = allocatedAcceleratorCount__swaptions3;
		inst->pendingAccelerators = 1;
		StartEverythingHandler_sig__Swaptions3LCacc(inst);
	}
};

#endif
#ifndef LCACC_BODY_TD__Swaptions3LCacc__X
#define LCACC_BODY_TD__Swaptions3LCacc__X

inline void Wait_td__Swaptions3LCacc(int thread)
{
...
inline void CreateBuffer_Swaptions3LCacc_td(uint8_t** buffer, uint32_t* bufferSize, uint8_t** constCluster, int thread, float (*ppdFactors)[3][11], float (*pdZ)[3][11], float (*shockVals)[55], int size, int chunk)
{
	MicroprogramWriter mw(false);
	void* LCAcc_FuncArgs__ppdFactors = ppdFactors;
...
inline void Swaptions3LCacc_td_buf(uint8_t* buf, uint32_t bufSize, int thread)
{
	...
	Wait_td__Swaptions3LCacc(thread);// wait for everything to finish
}
void Swaptions3LCacc_td(int thread, float (*ppdFactors)[3][11], float (*pdZ)[3][11], float (*shockVals)[55], int size, int chunk)
{
	uint32_t bufSize;
	uint8_t* buffer;
	uint8_t* constCluster = NULL;
	CreateBuffer_Swaptions3LCacc_td(&buffer, &bufSize, &constCluster, thread, ppdFactors, pdZ, shockVals, size, chunk);
	Swaptions3LCacc_td_buf(buffer, bufSize, thread);
	if(constCluster)
	{
		delete [] constCluster;
	}
...
inline uint32_t Swaptions3LCacc_CalculateBiNSize(int size, int chunk)
{
	return 0;
}
class BiN_Swaptions3LCacc_Arbitrator_td
{
	...
	InterruptArgs isr;
public:
	inline BiN_Swaptions3LCacc_Arbitrator_td(){}
	...
	inline void Run(int threadID)
	{
		...
		isr.lcaccID = 0;
		isr.lcaccMode = 0;
		LCAcc_DeclareLCAccUse(threadID, 1303, 1); //requests for swaptions3
		...
		for(size_t i = 0; i < binSizeSet.size(); i++)
		{
			...
			{
				Swaptions3LCacc_td_buf(bufSet[i], bufSizeSet[i], threadID);
				return;
			}
		}
		simics_assert(0);
