...
PREFIX=SW
SUFFIX=sw
COMMON_CONFIG="configs/example/fs.py --checkpoint-dir=${START_CKPT_DIR} --restore-with-cpu=timing -r 1 -n 1 --mem-size=2GB --caches --l2cache --l2_size=32MB --work-begin-exit-count=1"
