...
#ifdef SIM_NET_PORTS
class gem5PortMessage : public NetworkMessage
{
public:
	...
	const gem5PortMessage& operator = (const gem5PortMessage& m)
	{
        ...
        gem5PortMessage(Tick curTime) : NetworkMessage(curTime)
	{
	...
	virtual MsgPtr clone() const
	{
		...
		spm->length = length;
		spm->index = index;
		gem5NetworkPort::IncrementRef(msgHandle);
		return std::make_shared<gem5PortMessage>(*spm);
	}
	virtual void destroy()
	{
		gem5NetworkPort::DecrementRef(msgHandle);
		delete this;
	}
