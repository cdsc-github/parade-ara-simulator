...
namespace LCAcc
{
	...
	public:
		...
		inline virtual int InitiationInterval(){return 100;}
		inline virtual int PipelineDepth(){return 267;}
		inline virtual bool CallAllAtEnd(){return false;}
		inline static std::string GetModeName(){return "LPCIP";}
		...
		inline static int GetOpCode(){return 806;}
	};
}
