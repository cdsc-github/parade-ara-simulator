#ifndef LCACC_MODE_ROBLOC_DIMM_H
#define LCACC_MODE_ROBLOC_DIMM_H
...
namespace LCAcc
{
	class OperatingMode_RobLoc_dimm : public LCAccOperatingMode
	{
	public:
		inline OperatingMode_RobLoc_dimm(){}
