#ifndef LCACC_MODE_BLACKSCHOLES_DIMM_H
#define LCACC_MODE_BLACKSCHOLES_DIMM_H
...
namespace LCAcc
{
	class OperatingMode_blackScholes_dimm : public LCAccOperatingMode
	{
	public:
		inline OperatingMode_blackScholes_dimm(){}
