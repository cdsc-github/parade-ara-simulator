#ifndef LCACC_MODE_DENOISE1_H
#define LCACC_MODE_DENOISE1_H
...
namespace LCAcc
{
	class OperatingMode_denoise1 : public LCAccOperatingMode
	{
		int width;
		int height;
		int depth;
	public:
		inline OperatingMode_denoise1(){}
		...
		inline static std::string GetModeName(){return "denoise1";}
		...
		inline static int GetOpCode(){return 102;}
	};
}
