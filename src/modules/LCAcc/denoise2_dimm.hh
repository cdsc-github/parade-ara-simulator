#ifndef LCACC_MODE_DENOISE2_DIMM_H
#define LCACC_MODE_DENOISE2_DIMM_H
...
namespace LCAcc
{
	class OperatingMode_denoise2_dimm : public LCAccOperatingMode
	{
		int width;
		int height;
		int depth;
	public:
		inline OperatingMode_denoise2_dimm(){}
		...
		inline static std::string GetModeName(){return "denoise2_dimm";}
		...
		inline static int GetOpCode(){return 152;}
	};
}
