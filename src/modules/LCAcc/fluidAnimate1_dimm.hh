#ifndef LCACC_MODE_FLUIDANIMATE1_DIMM_H
#define LCACC_MODE_FLUIDANIMATE1_DIMM_H
...
namespace LCAcc
{
	class OperatingMode_fluidAnimate1_dimm : public LCAccOperatingMode
	{
	public:
		inline OperatingMode_fluidAnimate1_dimm(){}
