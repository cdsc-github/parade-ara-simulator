#ifndef LCACC_MODE_REGISTRATION_DIMM_H
#define LCACC_MODE_REGISTRATION_DIMM_H
...
namespace LCAcc
{
	class OperatingMode_registration_dimm : public LCAccOperatingMode
	{
		int width;
		int height;
		int depth;
	public:
		inline OperatingMode_registration_dimm(){}
		...
		inline static std::string GetModeName(){return "registration_dimm";}
		...
		inline static int GetOpCode(){return 351;}
	};
}
