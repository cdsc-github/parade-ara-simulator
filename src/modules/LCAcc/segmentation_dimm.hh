#ifndef LCACC_MODE_SEGMENTATION_DIMM_H
#define LCACC_MODE_SEGMENTATION_DIMM_H
...
namespace LCAcc
{
	class OperatingMode_segmentation_dimm : public LCAccOperatingMode
	{
		int width;
		int height;
		int depth;
	public:
		inline OperatingMode_segmentation_dimm(){}
		...
		inline static std::string GetModeName(){return "segmentation_dimm";}
		...
		inline static int GetOpCode(){return 251;}
	};
}
