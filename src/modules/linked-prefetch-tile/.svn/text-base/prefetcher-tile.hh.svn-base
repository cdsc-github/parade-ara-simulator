...
typedef struct prftch_direct_interface
{
	...
	void (*Prefetch)(DMAEngineHandle* dma, uint64_t srcAddr, unsigned int srcDimensions, const unsigned int* srcElementSize, const int* srcStride, size_t transferSize);
