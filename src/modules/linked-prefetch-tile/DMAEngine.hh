...
public:
    ...
    bool isRead() { return (srcSpmID == NO_SPM_ID); }

    void setPaddr(uint64_t paddr) { pAddr = paddr; }

    uint64_t getPaddr() { return pAddr; }
...
public:
    ...
    bool MoreTransfers() const { return start.addrGen.TotalSize() > index; }
