/*
  scratch-pad.hh: Scratchpad used in PARADE
*/
...
typedef struct scratch_pad_interface{
        void (*read)(ScratchPadHandle* obj, uint64_t address, void* dataRd, unsigned int size);
        void (*write)(ScratchPadHandle* obj, uint64_t address, const void* dataWr, unsigned int size);
